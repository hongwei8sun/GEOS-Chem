...
!           ENDIF
 ...
 700     CONTINUE
       ...
       DO t1s = 1, NINT(Dt/Pdt)
         ...
         Pc_bdy(:,:) = State_Chm%Species(i_lon,i_lat,i_lev,id_GC(i_species)) !!! shw
...
!           IF(Concnt2D_bdy(i_x, i_y)<0)THEN !!! shw
!                WRITE(6,*)'=================================================='
!                WRITE(6,*) "ERROR1: Concnt2D_bdy(i_x, i_y)<0 !!!", Pdt
!                WRITE(6,*) i_x, i_y, Concnt2D_bdy(i_x, i_y), Pc_middle
!                WRITE(6,*) CFL, Pc_right, Pc_left
!		WRITE(6,*) i_x, i_y, 0.5 * CFL    * ( Pc_right - Pc_left )
!		WRITE(6,*) i_x, i_y, 0.5 * CFL**2 * ( Pc_right - 2*Pc_middle + Pc_left )
!                WRITE(6,*)'=================================================='
!           ENDIF
 ...
 701     CONTINUE
       ...
       CFL = Pdt*Pu(1,1)/Pdx
       IF( MAX( ABS(2*eddy_h*Pdt/(Pdx**2)) &
	       ,ABS(2*eddy_v*Pdt/(Pdy**2)) )>0.5 )THEN
           Nt = Nt+1
           Pdt = Dt/Nt
           GOTO 701
       ENDIF
...
!	   IF(Concnt2D_bdy(i_x, i_y)<0)THEN !!! shw
!		WRITE(6,*)'=================================================='
!		WRITE(6,*) "ERROR2: Concnt2D_bdy(i_x, i_y)<0 !!!", Pdt
!		WRITE(6,*) i_x, i_y, Concnt2D_bdy(i_x, i_y), Pc_middle
!		WRITE(6,*) CFL, 2*eddy_h*Pdt/(Pdx**2), 2*eddy_v*Pdt/(Pdy**2)
!		WRITE(6,*) Pdt*( eddy_h*( Pc_right -2*Pc_middle +Pc_left   ) /(Pdx**2) &
!                     +eddy_v*( Pc_top   -2*Pc_middle +Pc_bottom ) /(Pdy**2) )
!		WRITE(6,*)'=================================================='
!	   ENDIF
...
!         WRITE(6,*)'shw, State_Chm%Species', i_species, box_life, backgrd_concnt
!         WRITE(6,*) mass_plume_new, mass_plume, grid_volumn
!	 WRITE(6,*) 'n_x_mid:'
!         WRITE(6,*)  box_concnt_2D(n_x_mid,:,i_species)
!	 WRITE(6,*) "n_y_mid:"
!         WRITE(6,*)  box_concnt_2D(:,n_y_mid,i_species)
...
!        WRITE(6,*)'BEFORE: box_concnt_2D:', i_species
!        WRITE(6,*) box_concnt_2D(n_x_mid,:,i_species)
!        WRITE(6,*) box_concnt_2D(:,n_y_mid,i_species)
