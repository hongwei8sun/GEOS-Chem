...
!shw   USE HCOX_GeoEng_Mod,        ONLY : HCOX_GeoEng_Init
...
!
    ...
    IF ( .not. HcoState%Options%isDryRun ) THEN
       ...
       !-----------------------------------------------------------------------
! shw       CALL HCOX_GeoEng_Init( amIRoot,  HcoState, 'GeoEng', &
!                              ExtState,  RC ) 
!       IF ( RC /= HCO_SUCCESS ) Then
...
!shw    USE HCOX_GeoEng_Mod,        ONLY : HCOX_GeoEng_Run
...
!shw    USE HCOX_GeoEng_Mod,        ONLY : HCOX_GeoEng_Final
