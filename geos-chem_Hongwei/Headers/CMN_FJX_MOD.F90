...
!  INTEGER, PARAMETER ::  A_    = 56+39 !!! shw40
...
!BOC
    ...
    IF ( Input_Opt%LUCX ) THEN
       AN_          = 37  ! # of separate aerosols per layer; Including PSCs !!! shw40
       W_           = 18  ! # of wavelength bins

       ! For RRTMG:
       NSPAA        = 47  !8  ! number of species in LUT	!!! shw40
       NASPECRAD    = 55  !16 ! aerosol species in RT 		!!! shw40
       NSPECRAD     = 57  !18 ! aerosol+gas species in RT 	!!! shw40
    ELSE
