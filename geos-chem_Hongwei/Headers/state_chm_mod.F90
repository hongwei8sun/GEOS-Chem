...
!
    ...
    ! Strings
    CHARACTER(LEN=255)     :: ErrMsg, ThisLoc, ChmID, ChmID_name
...
!          END SELECT
          ...
          SELECT CASE( N )
             ...
             CASE( 12 )
                chmID = 'AeroAreaSSC'
             CASE( 13 )
                chmID = 'AeroAreaBGSULF01'
             CASE( 14 )
                chmID = 'AeroAreaBGSULF02'
             CASE( 15 )
                chmID = 'AeroAreaBGSULF03'
             CASE( 16 )
                chmID = 'AeroAreaBGSULF04'
             CASE( 17 )
                chmID = 'AeroAreaBGSULF05'
             CASE( 18 )
                chmID = 'AeroAreaBGSULF06'
             CASE( 19 )
                chmID = 'AeroAreaBGSULF07'
             CASE( 20 )
                chmID = 'AeroAreaBGSULF08'
             CASE( 21 )
                chmID = 'AeroAreaBGSULF09'
             CASE( 22 )
                chmID = 'AeroAreaBGSULF10'
             CASE( 23 )
                chmID = 'AeroAreaBGSULF11'
             CASE( 24 )
                chmID = 'AeroAreaBGSULF12'
             CASE( 25 )
                chmID = 'AeroAreaBGSULF13'
             CASE( 26 )
                chmID = 'AeroAreaBGSULF14'
             CASE( 27 )
                chmID = 'AeroAreaBGSULF15'
             CASE( 28 )
                chmID = 'AeroAreaBGSULF16'
             CASE( 29 )
                chmID = 'AeroAreaBGSULF17'
             CASE( 30 )
                chmID = 'AeroAreaBGSULF18'
             CASE( 31 )
                chmID = 'AeroAreaBGSULF19'
             CASE( 32 )
                chmID = 'AeroAreaBGSULF20'
             CASE( 33 )
                chmID = 'AeroAreaBGSULF21'
             CASE( 34 )
                chmID = 'AeroAreaBGSULF22'
             CASE( 35 )
                chmID = 'AeroAreaBGSULF23'
             CASE( 36 )
                chmID = 'AeroAreaBGSULF24'
             CASE( 37 )
                chmID = 'AeroAreaBGSULF25'
             CASE( 38 )
                chmID = 'AeroAreaBGSULF26'
             CASE( 39 )
                chmID = 'AeroAreaBGSULF27'
             CASE( 40 )
                chmID = 'AeroAreaBGSULF28'
             CASE( 41 )
                chmID = 'AeroAreaBGSULF29'
             CASE( 42 )
                chmID = 'AeroAreaBGSULF30'
             CASE( 43 )
                chmID = 'AeroAreaBGSULF31'
             CASE( 44 )
                chmID = 'AeroAreaBGSULF32'
             CASE( 45 )
                chmID = 'AeroAreaBGSULF33'
             CASE( 46 )
                chmID = 'AeroAreaBGSULF34'
             CASE( 47 )
                chmID = 'AeroAreaBGSULF35'
             CASE( 48 )
                chmID = 'AeroAreaBGSULF36'
             CASE( 49 )
                chmID = 'AeroAreaBGSULF37'
             CASE( 50 )
                chmID = 'AeroAreaBGSULF38'
             CASE( 51 )
                chmID = 'AeroAreaBGSULF39'
             CASE( 52 )
                chmID = 'AeroAreaBGSULF40'
             CASE( 53 )
                chmID  = 'AeroAreaICEI'
             CASE DEFAULT
                ErrMsg = 'State_Chm%nAeroType exceeds the number of defined' &
...
!          END SELECT
          ...
          SELECT CASE( N )
             ...
             CASE( 12 )
                chmID = 'AeroRadiSSC'
             CASE( 13 )
                chmID = 'AeroRadiBGSULF01'
             CASE( 14 )
                chmID = 'AeroRadiBGSULF02'
             CASE( 15 )
                chmID = 'AeroRadiBGSULF03'
             CASE( 16 )
                chmID = 'AeroRadiBGSULF04'
             CASE( 17 )
                chmID = 'AeroRadiBGSULF05'
             CASE( 18 )
                chmID = 'AeroRadiBGSULF06'
             CASE( 19 )
                chmID = 'AeroRadiBGSULF07'
             CASE( 20 )
                chmID = 'AeroRadiBGSULF08'
             CASE( 21 )
                chmID = 'AeroRadiBGSULF09'
             CASE( 22 )
                chmID = 'AeroRadiBGSULF10'
             CASE( 23 )
                chmID = 'AeroRadiBGSULF11'
             CASE( 24 )
                chmID = 'AeroRadiBGSULF12'
             CASE( 25 )
                chmID = 'AeroRadiBGSULF13'
             CASE( 26 )
                chmID = 'AeroRadiBGSULF14'
             CASE( 27 )
                chmID = 'AeroRadiBGSULF15'
             CASE( 28 )
                chmID = 'AeroRadiBGSULF16'
             CASE( 29 )
                chmID = 'AeroRadiBGSULF17'
             CASE( 30 )
                chmID = 'AeroRadiBGSULF18'
             CASE( 31 )
                chmID = 'AeroRadiBGSULF19'
             CASE( 32 )
                chmID = 'AeroRadiBGSULF20'
             CASE( 33 )
                chmID = 'AeroRadiBGSULF21'
             CASE( 34 )
                chmID = 'AeroRadiBGSULF22'
             CASE( 35 )
                chmID = 'AeroRadiBGSULF23'
             CASE( 36 )
                chmID = 'AeroRadiBGSULF24'
             CASE( 37 )
                chmID = 'AeroRadiBGSULF25'
             CASE( 38 )
                chmID = 'AeroRadiBGSULF26'
             CASE( 39 )
                chmID = 'AeroRadiBGSULF27'
             CASE( 40 )
                chmID = 'AeroRadiBGSULF28'
             CASE( 41 )
                chmID = 'AeroRadiBGSULF29'
             CASE( 42 )
                chmID = 'AeroRadiBGSULF30'
             CASE( 43 )
                chmID = 'AeroRadiBGSULF31'
             CASE( 44 )
                chmID = 'AeroRadiBGSULF32'
             CASE( 45 )
                chmID = 'AeroRadiBGSULF33'
             CASE( 46 )
                chmID = 'AeroRadiBGSULF34'
             CASE( 47 )
                chmID = 'AeroRadiBGSULF33'
             CASE( 48 )
                chmID = 'AeroRadiBGSULF34'
             CASE( 49 )
                chmID = 'AeroRadiBGSULF35'
             CASE( 50 )
                chmID = 'AeroRadiBGSULF36'
             CASE( 51 )
                chmID = 'AeroRadiBGSULF37'
             CASE( 52 )
                chmID = 'AeroRadiBGSULF38'
             CASE( 53 )
                chmID = 'AeroRadiBGSULF39'
             CASE( 54 )
                chmID = 'AeroRadiBGSULF40'
             CASE( 55 )
                chmID = 'AeroRadiICEI'
             CASE DEFAULT
                ErrMsg = 'State_Chm%nAeroType exceeds the number of defined' &
...
!          END SELECT
          ...
          SELECT CASE( N )
             ...
             CASE( 12 )
                chmID = 'WetAeroAreaSSC'
             CASE( 13 )
                chmID = 'WetAeroAreaBGSULF01'
             CASE( 14 )
                chmID = 'WetAeroAreaBGSULF02'
             CASE( 15 )
                chmID = 'WetAeroAreaBGSULF03'
             CASE( 16 )
                chmID = 'WetAeroAreaBGSULF04'
             CASE( 17 )
                chmID = 'WetAeroAreaBGSULF05'
             CASE( 18 )
                chmID = 'WetAeroAreaBGSULF06'
             CASE( 19 )
                chmID = 'WetAeroAreaBGSULF07'
             CASE( 20 )
                chmID = 'WetAeroAreaBGSULF08'
             CASE( 21 )
                chmID = 'WetAeroAreaBGSULF09'
             CASE( 22 )
                chmID = 'WetAeroAreaBGSULF10'
             CASE( 23 )
                chmID = 'WetAeroAreaBGSULF11'
             CASE( 24 )
                chmID = 'WetAeroAreaBGSULF12'
             CASE( 25 )
                chmID = 'WetAeroAreaBGSULF13'
             CASE( 26 )
                chmID = 'WetAeroAreaBGSULF14'
             CASE( 27 )
                chmID = 'WetAeroAreaBGSULF15'
             CASE( 28 )
                chmID = 'WetAeroAreaBGSULF16'
             CASE( 29 )
                chmID = 'WetAeroAreaBGSULF17'
             CASE( 30 )
                chmID = 'WetAeroAreaBGSULF18'
             CASE( 31 )
                chmID = 'WetAeroAreaBGSULF19'
             CASE( 32 )
                chmID = 'WetAeroAreaBGSULF20'
             CASE( 33 )
                chmID = 'WetAeroAreaBGSULF21'
             CASE( 34 )
                chmID = 'WetAeroAreaBGSULF22'
             CASE( 35 )
                chmID = 'WetAeroAreaBGSULF23'
             CASE( 36 )
                chmID = 'WetAeroAreaBGSULF24'
             CASE( 37 )
                chmID = 'WetAeroAreaBGSULF25'
             CASE( 38 )
                chmID = 'WetAeroAreaBGSULF26'
             CASE( 39 )
                chmID = 'WetAeroAreaBGSULF27'
             CASE( 40 )
                chmID = 'WetAeroAreaBGSULF28'
             CASE( 41 )
                chmID = 'WetAeroAreaBGSULF29'
             CASE( 42 )
                chmID = 'WetAeroAreaBGSULF30'
             CASE( 43 )
                chmID = 'WetAeroAreaBGSULF31'
             CASE( 44 )
                chmID = 'WetAeroAreaBGSULF32'
             CASE( 45 )
                chmID = 'WetAeroAreaBGSULF33'
             CASE( 46 )
                chmID = 'WetAeroAreaBGSULF34'
             CASE( 47 )
                chmID = 'WetAeroAreaBGSULF35'
             CASE( 48 )
                chmID = 'WetAeroAreaBGSULF36'
             CASE( 49 )
                chmID = 'WetAeroAreaBGSULF37'
             CASE( 50 )
                chmID = 'WetAeroAreaBGSULF38'
             CASE( 51 )
                chmID = 'WetAeroAreaBGSULF39'
             CASE( 52 )
                chmID = 'WetAeroAreaBGSULF40'
             CASE( 53 )
                chmID = 'WetAeroAreaICEI'
             CASE DEFAULT
                ErrMsg = 'State_Chm%nAeroType exceeds the number of defined' &
...
!          END SELECT
          ...
          SELECT CASE( N )
             ...
             CASE( 12 )
                chmID = 'WetAeroRadiSSC'
             CASE( 13 )
                chmID = 'WetAeroRadiBGSULF01'
             CASE( 14 )
                chmID = 'WetAeroRadiBGSULF02'
             CASE( 15 )
                chmID = 'WetAeroRadiBGSULF03'
             CASE( 16 )
                chmID = 'WetAeroRadiBGSULF04'
             CASE( 17 )
                chmID = 'WetAeroRadiBGSULF05'
             CASE( 18 )
                chmID = 'WetAeroRadiBGSULF06'
             CASE( 19 )
                chmID = 'WetAeroRadiBGSULF07'
             CASE( 20 )
                chmID = 'WetAeroRadiBGSULF08'
             CASE( 21 )
                chmID = 'WetAeroRadiBGSULF09'
             CASE( 22 )
                chmID = 'WetAeroRadiBGSULF10'
             CASE( 23 )
                chmID = 'WetAeroRadiBGSULF11'
             CASE( 24 )
                chmID = 'WetAeroRadiBGSULF12'
             CASE( 25 )
                chmID = 'WetAeroRadiBGSULF13'
             CASE( 26 )
                chmID = 'WetAeroRadiBGSULF14'
             CASE( 27 )
                chmID = 'WetAeroRadiBGSULF15'
             CASE( 28 )
                chmID = 'WetAeroRadiBGSULF16'
             CASE( 29 )
                chmID = 'WetAeroRadiBGSULF17'
             CASE( 30 )
                chmID = 'WetAeroRadiBGSULF18'
             CASE( 31 )
                chmID = 'WetAeroRadiBGSULF19'
             CASE( 32 )
                chmID = 'WetAeroRadiBGSULF20'
             CASE( 33 )
                chmID = 'WetAeroRadiBGSULF21'
             CASE( 34 )
                chmID = 'WetAeroRadiBGSULF22'
             CASE( 35 )
                chmID = 'WetAeroRadiBGSULF23'
             CASE( 36 )
                chmID = 'WetAeroRadiBGSULF24'
             CASE( 37 )
                chmID = 'WetAeroRadiBGSULF25'
             CASE( 38 )
                chmID = 'WetAeroRadiBGSULF26'
             CASE( 39 )
                chmID = 'WetAeroRadiBGSULF27'
             CASE( 40 )
                chmID = 'WetAeroRadiBGSULF28'
             CASE( 41 )
                chmID = 'WetAeroRadiBGSULF29'
             CASE( 42 )
                chmID = 'WetAeroRadiBGSULF30'
             CASE( 43 )
                chmID = 'WetAeroRadiBGSULF31'
             CASE( 44 )
                chmID = 'WetAeroRadiBGSULF32'
             CASE( 45 )
                chmID = 'WetAeroRadiBGSULF33'
             CASE( 46 )
                chmID = 'WetAeroRadiBGSULF34'
             CASE( 47 )
                chmID = 'WetAeroRadiBGSULF35'
             CASE( 48 )
                chmID = 'WetAeroRadiBGSULF36'
             CASE( 49 )
                chmID = 'WetAeroRadiBGSULF37'
             CASE( 50 )
                chmID = 'WetAeroRadiBGSULF38'
             CASE( 51 )
                chmID = 'WetAeroRadiBGSULF39'
             CASE( 52 )
                chmID = 'WetAeroRadiBGSULF40'
             CASE( 53 )
                chmID = 'WetAeroRadiICEI'
             CASE DEFAULT
                ErrMsg = 'State_Chm%nAeroType exceeds the number of defined' &
...
!          END SELECT
          ...
          SELECT CASE( N )
             ...
             CASE( 12 )
                chmID = 'AeroH2OSSC'
             CASE( 13 )
                chmID = 'AeroH2OBGSULF01'
             CASE( 14 )
                chmID = 'AeroH2OBGSULF02'
             CASE( 15 )
                chmID = 'AeroH2OBGSULF03'
             CASE( 16 )
                chmID = 'AeroH2OBGSULF04'
             CASE( 17 )
                chmID = 'AeroH2OBGSULF05'
             CASE( 18 )
                chmID = 'AeroH2OBGSULF06'
             CASE( 19 )
                chmID = 'AeroH2OBGSULF07'
             CASE( 20 )
                chmID = 'AeroH2OBGSULF08'
             CASE( 21 )
                chmID = 'AeroH2OBGSULF09'
             CASE( 22 )
                chmID = 'AeroH2OBGSULF10'
             CASE( 23 )
                chmID = 'AeroH2OBGSULF11'
             CASE( 24 )
                chmID = 'AeroH2OBGSULF12'
             CASE( 25 )
                chmID = 'AeroH2OBGSULF13'
             CASE( 26 )
                chmID = 'AeroH2OBGSULF14'
             CASE( 27 )
                chmID = 'AeroH2OBGSULF15'
             CASE( 28 )
                chmID = 'AeroH2OBGSULF16'
             CASE( 29 )
                chmID = 'AeroH2OBGSULF17'
             CASE( 30 )
                chmID = 'AeroH2OBGSULF18'
             CASE( 31 )
                chmID = 'AeroH2OBGSULF19'
             CASE( 32 )
                chmID = 'AeroH2OBGSULF20'
             CASE( 33 )
                chmID = 'AeroH2OBGSULF21'
             CASE( 34 )
                chmID = 'AeroH2OBGSULF22'
             CASE( 35 )
                chmID = 'AeroH2OBGSULF23'
             CASE( 36 )
                chmID = 'AeroH2OBGSULF24'
             CASE( 37 )
                chmID = 'AeroH2OBGSULF25'
             CASE( 38 )
                chmID = 'AeroH2OBGSULF26'
             CASE( 39 )
                chmID = 'AeroH2OBGSULF27'
             CASE( 40 )
                chmID = 'AeroH2OBGSULF28'
             CASE( 41 )
                chmID = 'AeroH2OBGSULF29'
             CASE( 42 )
                chmID = 'AeroH2OBGSULF30'
             CASE( 43 )
                chmID = 'AeroH2OBGSULF31'
             CASE( 44 )
                chmID = 'AeroH2OBGSULF32'
             CASE( 45 )
                chmID = 'AeroH2OBGSULF33'
             CASE( 46 )
                chmID = 'AeroH2OBGSULF34'
             CASE( 47 )
                chmID = 'AeroH2OBGSULF35'
             CASE( 48 )
                chmID = 'AeroH2OBGSULF36'
             CASE( 49 )
                chmID = 'AeroH2OBGSULF37'
             CASE( 50 )
                chmID = 'AeroH2OBGSULF38'
             CASE( 51 )
                chmID = 'AeroH2OBGSULF39'
             CASE( 52 )
                chmID = 'AeroH2OBGSULF40'
             CASE( 53 )
                chmID = 'AeroH2OICEI'
             CASE DEFAULT
                ErrMsg = 'State_Chm%nAeroType exceeds the number of defined' &
...
!!! shw40
       ...
       DO N = 1, nKHLSA
	     ...
	     CASE(1:40)
		write(chmID_name,*) N
                chmID = 'KhetiSLAN2O5H2O_'//ADJUSTL(chmID_name)
	     CASE(41:80)
                write(chmID_name,*) N-40
                chmID = 'KhetiSLAN2O5HCl_'//ADJUSTL(chmID_name)
	     CASE(81:120)
                write(chmID_name,*) N-80
                chmID = 'KhetiSLAClNO3H2O_'//ADJUSTL(chmID_name)
	     CASE(121:160)
                write(chmID_name,*) N-120
                chmID = 'KhetiSLAClNO3HCl_'//ADJUSTL(chmID_name)
	     CASE(161:200)
                write(chmID_name,*) N-160
                chmID = 'KhetiSLAClNO3HBr_'//ADJUSTL(chmID_name)
	     CASE(201:240)
                write(chmID_name,*) N-200
                chmID = 'KhetiSLABrNO3H2O_'//ADJUSTL(chmID_name)
	     CASE(241:280)
                write(chmID_name,*) N-240
                chmID = 'KhetiSLABrNO3HCl_'//ADJUSTL(chmID_name)
	     CASE(281:320)
                write(chmID_name,*) N-280
                chmID = 'KhetiSLAHOClHCl_'//ADJUSTL(chmID_name)
	     CASE(321:360)
                write(chmID_name,*) N-320
                chmID = 'KhetiSLAHOClHBr_'//ADJUSTL(chmID_name)
	     CASE(361:400)
                write(chmID_name,*) N-360
                chmID = 'KhetiSLAHOBrHCl_'//ADJUSTL(chmID_name)
	     CASE(401:440)
                write(chmID_name,*) N-400
                chmID = 'KhetiSLAHOBrHBr_'//ADJUSTL(chmID_name)
             CASE DEFAULT
                ErrMsg = 'nKHLSA exceeds the number of defined' &
                       // ' KHETI_SLA categories'
                CALL GC_Error( ErrMsg, RC, ThisLoc )
    ...
    If (Input_Opt%ITS_A_FULLCHEM_SIM.and.Input_Opt%LStratMicro) Then
       ...
       ! KHETI_SLA
       !-------------------------------------------------------------------
       nBin = 40  ! TODO: Need to get this from somewhere else !!! shw40
...
!
    ...
    SELECT CASE ( TRIM( Name_AllCaps ) )
       ...
       !!! shw40
       CASE ( 'AEROAREABGSULF01' )
          IF ( isDesc  ) Desc  = 'Dry aerosol area for background' &
                                 // ' stratospheric sulfate bin_01'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROAREABGSULF02' )
          IF ( isDesc  ) Desc  = 'Dry aerosol area for background' &
                                 // ' stratospheric sulfate bin_02'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROAREABGSULF03' )
          IF ( isDesc  ) Desc  = 'Dry aerosol area for background' &
                                 // ' stratospheric sulfate bin_03'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROAREABGSULF04' )
          IF ( isDesc  ) Desc  = 'Dry aerosol area for background' &
                                 // ' stratospheric sulfate bin_04'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROAREABGSULF05' )
          IF ( isDesc  ) Desc  = 'Dry aerosol area for background' &
                                 // ' stratospheric sulfate bin_05'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROAREABGSULF06' )
          IF ( isDesc  ) Desc  = 'Dry aerosol area for background' &
                                 // ' stratospheric sulfate bin_06'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROAREABGSULF07' )
          IF ( isDesc  ) Desc  = 'Dry aerosol area for background' &
                                 // ' stratospheric sulfate bin_07'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROAREABGSULF08' )
          IF ( isDesc  ) Desc  = 'Dry aerosol area for background' &
                                 // ' stratospheric sulfate bin_08'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROAREABGSULF09' )
          IF ( isDesc  ) Desc  = 'Dry aerosol area for background' &
                                 // ' stratospheric sulfate bin_09'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROAREABGSULF10' )
          IF ( isDesc  ) Desc  = 'Dry aerosol area for background' &
                                 // ' stratospheric sulfate bin_10'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROAREABGSULF11' )
          IF ( isDesc  ) Desc  = 'Dry aerosol area for background' &
                                 // ' stratospheric sulfate bin_11'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROAREABGSULF12' )
          IF ( isDesc  ) Desc  = 'Dry aerosol area for background' &
                                 // ' stratospheric sulfate bin_12'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROAREABGSULF13' )
          IF ( isDesc  ) Desc  = 'Dry aerosol area for background' &
                                 // ' stratospheric sulfate bin_13'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROAREABGSULF14' )
          IF ( isDesc  ) Desc  = 'Dry aerosol area for background' &
                                 // ' stratospheric sulfate bin_14'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROAREABGSULF15' )
          IF ( isDesc  ) Desc  = 'Dry aerosol area for background' &
                                 // ' stratospheric sulfate bin_15'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROAREABGSULF16' )
          IF ( isDesc  ) Desc  = 'Dry aerosol area for background' &
                                 // ' stratospheric sulfate bin_16'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROAREABGSULF17' )
          IF ( isDesc  ) Desc  = 'Dry aerosol area for background' &
                                 // ' stratospheric sulfate bin_17'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROAREABGSULF18' )
          IF ( isDesc  ) Desc  = 'Dry aerosol area for background' &
                                 // ' stratospheric sulfate bin_18'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROAREABGSULF19' )
          IF ( isDesc  ) Desc  = 'Dry aerosol area for background' &
                                 // ' stratospheric sulfate bin_19'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROAREABGSULF20' )
          IF ( isDesc  ) Desc  = 'Dry aerosol area for background' &
                                 // ' stratospheric sulfate bin_20'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROAREABGSULF21' )
          IF ( isDesc  ) Desc  = 'Dry aerosol area for background' &
                                 // ' stratospheric sulfate bin_21'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROAREABGSULF22' )
          IF ( isDesc  ) Desc  = 'Dry aerosol area for background' &
                                 // ' stratospheric sulfate bin_22'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROAREABGSULF23' )
          IF ( isDesc  ) Desc  = 'Dry aerosol area for background' &
                                 // ' stratospheric sulfate bin_23'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROAREABGSULF24' )
          IF ( isDesc  ) Desc  = 'Dry aerosol area for background' &
                                 // ' stratospheric sulfate bin_24'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROAREABGSULF25' )
          IF ( isDesc  ) Desc  = 'Dry aerosol area for background' &
                                 // ' stratospheric sulfate bin_25'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROAREABGSULF26' )
          IF ( isDesc  ) Desc  = 'Dry aerosol area for background' &
                                 // ' stratospheric sulfate bin_26'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROAREABGSULF27' )
          IF ( isDesc  ) Desc  = 'Dry aerosol area for background' &
                                 // ' stratospheric sulfate bin_27'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROAREABGSULF28' )
          IF ( isDesc  ) Desc  = 'Dry aerosol area for background' &
                                 // ' stratospheric sulfate bin_28'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROAREABGSULF29' )
          IF ( isDesc  ) Desc  = 'Dry aerosol area for background' &
                                 // ' stratospheric sulfate bin_29'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROAREABGSULF30' )
          IF ( isDesc  ) Desc  = 'Dry aerosol area for background' &
                                 // ' stratospheric sulfate bin_30'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROAREABGSULF31' )
          IF ( isDesc  ) Desc  = 'Dry aerosol area for background' &
                                 // ' stratospheric sulfate bin_31'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROAREABGSULF32' )
          IF ( isDesc  ) Desc  = 'Dry aerosol area for background' &
                                 // ' stratospheric sulfate bin_32'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROAREABGSULF33' )
          IF ( isDesc  ) Desc  = 'Dry aerosol area for background' &
                                 // ' stratospheric sulfate bin_33'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROAREABGSULF34' )
          IF ( isDesc  ) Desc  = 'Dry aerosol area for background' &
                                 // ' stratospheric sulfate bin_34'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROAREABGSULF35' )
          IF ( isDesc  ) Desc  = 'Dry aerosol area for background' &
                                 // ' stratospheric sulfate bin_35'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROAREABGSULF36' )
          IF ( isDesc  ) Desc  = 'Dry aerosol area for background' &
                                 // ' stratospheric sulfate bin_36'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROAREABGSULF37' )
          IF ( isDesc  ) Desc  = 'Dry aerosol area for background' &
                                 // ' stratospheric sulfate bin_37'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROAREABGSULF38' )
          IF ( isDesc  ) Desc  = 'Dry aerosol area for background' &
                                 // ' stratospheric sulfate bin_38'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROAREABGSULF39' )
          IF ( isDesc  ) Desc  = 'Dry aerosol area for background' &
                                 // ' stratospheric sulfate bin_39'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROAREABGSULF40' )
          IF ( isDesc  ) Desc  = 'Dry aerosol area for background' &
                                 // ' stratospheric sulfate bin_40'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3
       ...
       !!! shw40
       CASE ( 'AERORADIBGSULF01' )
          IF ( isDesc  ) Desc  = 'Dry aerosol radius for background' &
                                 // ' stratospheric sulfate bin_01'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AERORADIBGSULF02' )
          IF ( isDesc  ) Desc  = 'Dry aerosol radius for background' &
                                 // ' stratospheric sulfate bin_02'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AERORADIBGSULF03' )
          IF ( isDesc  ) Desc  = 'Dry aerosol radius for background' &
                                 // ' stratospheric sulfate bin_03'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AERORADIBGSULF04' )
          IF ( isDesc  ) Desc  = 'Dry aerosol radius for background' &
                                 // ' stratospheric sulfate bin_04'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AERORADIBGSULF05' )
          IF ( isDesc  ) Desc  = 'Dry aerosol radius for background' &
                                 // ' stratospheric sulfate bin_05'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AERORADIBGSULF06' )
          IF ( isDesc  ) Desc  = 'Dry aerosol radius for background' &
                                 // ' stratospheric sulfate bin_06'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AERORADIBGSULF07' )
          IF ( isDesc  ) Desc  = 'Dry aerosol radius for background' &
                                 // ' stratospheric sulfate bin_07'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AERORADIBGSULF08' )
          IF ( isDesc  ) Desc  = 'Dry aerosol radius for background' &
                                 // ' stratospheric sulfate bin_08'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AERORADIBGSULF09' )
          IF ( isDesc  ) Desc  = 'Dry aerosol radius for background' &
                                 // ' stratospheric sulfate bin_09'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AERORADIBGSULF10' )
          IF ( isDesc  ) Desc  = 'Dry aerosol radius for background' &
                                 // ' stratospheric sulfate bin_10'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AERORADIBGSULF11' )
          IF ( isDesc  ) Desc  = 'Dry aerosol radius for background' &
                                 // ' stratospheric sulfate bin_11'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AERORADIBGSULF12' )
          IF ( isDesc  ) Desc  = 'Dry aerosol radius for background' &
                                 // ' stratospheric sulfate bin_12'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AERORADIBGSULF13' )
          IF ( isDesc  ) Desc  = 'Dry aerosol radius for background' &
                                 // ' stratospheric sulfate bin_13'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AERORADIBGSULF14' )
          IF ( isDesc  ) Desc  = 'Dry aerosol radius for background' &
                                 // ' stratospheric sulfate bin_14'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AERORADIBGSULF15' )
          IF ( isDesc  ) Desc  = 'Dry aerosol radius for background' &
                                 // ' stratospheric sulfate bin_15'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AERORADIBGSULF16' )
          IF ( isDesc  ) Desc  = 'Dry aerosol radius for background' &
                                 // ' stratospheric sulfate bin_16'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AERORADIBGSULF17' )
          IF ( isDesc  ) Desc  = 'Dry aerosol radius for background' &
                                 // ' stratospheric sulfate bin_17'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AERORADIBGSULF18' )
          IF ( isDesc  ) Desc  = 'Dry aerosol radius for background' &
                                 // ' stratospheric sulfate bin_18'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AERORADIBGSULF19' )
          IF ( isDesc  ) Desc  = 'Dry aerosol radius for background' &
                                 // ' stratospheric sulfate bin_19'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AERORADIBGSULF20' )
          IF ( isDesc  ) Desc  = 'Dry aerosol radius for background' &
                                 // ' stratospheric sulfate bin_20'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AERORADIBGSULF21' )
          IF ( isDesc  ) Desc  = 'Dry aerosol radius for background' &
                                 // ' stratospheric sulfate bin_21'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AERORADIBGSULF22' )
          IF ( isDesc  ) Desc  = 'Dry aerosol radius for background' &
                                 // ' stratospheric sulfate bin_22'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AERORADIBGSULF23' )
          IF ( isDesc  ) Desc  = 'Dry aerosol radius for background' &
                                 // ' stratospheric sulfate bin_23'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AERORADIBGSULF24' )
          IF ( isDesc  ) Desc  = 'Dry aerosol radius for background' &
                                 // ' stratospheric sulfate bin_24'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AERORADIBGSULF25' )
          IF ( isDesc  ) Desc  = 'Dry aerosol radius for background' &
                                 // ' stratospheric sulfate bin_25'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AERORADIBGSULF26' )
          IF ( isDesc  ) Desc  = 'Dry aerosol radius for background' &
                                 // ' stratospheric sulfate bin_26'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AERORADIBGSULF27' )
          IF ( isDesc  ) Desc  = 'Dry aerosol radius for background' &
                                 // ' stratospheric sulfate bin_27'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AERORADIBGSULF28' )
          IF ( isDesc  ) Desc  = 'Dry aerosol radius for background' &
                                 // ' stratospheric sulfate bin_28'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AERORADIBGSULF29' )
          IF ( isDesc  ) Desc  = 'Dry aerosol radius for background' &
                                 // ' stratospheric sulfate bin_29'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AERORADIBGSULF30' )
          IF ( isDesc  ) Desc  = 'Dry aerosol radius for background' &
                                 // ' stratospheric sulfate bin_30'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AERORADIBGSULF31' )
          IF ( isDesc  ) Desc  = 'Dry aerosol radius for background' &
                                 // ' stratospheric sulfate bin_31'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AERORADIBGSULF32' )
          IF ( isDesc  ) Desc  = 'Dry aerosol radius for background' &
                                 // ' stratospheric sulfate bin_32'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AERORADIBGSULF33' )
          IF ( isDesc  ) Desc  = 'Dry aerosol radius for background' &
                                 // ' stratospheric sulfate bin_33'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AERORADIBGSULF34' )
          IF ( isDesc  ) Desc  = 'Dry aerosol radius for background' &
                                 // ' stratospheric sulfate bin_34'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AERORADIBGSULF35' )
          IF ( isDesc  ) Desc  = 'Dry aerosol radius for background' &
                                 // ' stratospheric sulfate bin_35'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AERORADIBGSULF36' )
          IF ( isDesc  ) Desc  = 'Dry aerosol radius for background' &
                                 // ' stratospheric sulfate bin_36'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AERORADIBGSULF37' )
          IF ( isDesc  ) Desc  = 'Dry aerosol radius for background' &
                                 // ' stratospheric sulfate bin_37'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AERORADIBGSULF38' )
          IF ( isDesc  ) Desc  = 'Dry aerosol radius for background' &
                                 // ' stratospheric sulfate bin_38'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AERORADIBGSULF39' )
          IF ( isDesc  ) Desc  = 'Dry aerosol radius for background' &
                                 // ' stratospheric sulfate bin_39'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AERORADIBGSULF40' )
          IF ( isDesc  ) Desc  = 'Dry aerosol radius for background' &
                                 // ' stratospheric sulfate bin_40'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3
       ...
       !!! shw40
       CASE ( 'WETAEROAREABGSULF01' )
          IF ( isDesc  ) Desc  = 'Wet aerosol area for background' &
                                 // ' stratospheric sulfate bin_01'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAEROAREABGSULF02' )
          IF ( isDesc  ) Desc  = 'Wet aerosol area for background' &
                                 // ' stratospheric sulfate bin_02'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAEROAREABGSULF03' )
          IF ( isDesc  ) Desc  = 'Wet aerosol area for background' &
                                 // ' stratospheric sulfate bin_03'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAEROAREABGSULF04' )
          IF ( isDesc  ) Desc  = 'Wet aerosol area for background' &
                                 // ' stratospheric sulfate bin_04'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAEROAREABGSULF05' )
          IF ( isDesc  ) Desc  = 'Wet aerosol area for background' &
                                 // ' stratospheric sulfate bin_05'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAEROAREABGSULF06' )
          IF ( isDesc  ) Desc  = 'Wet aerosol area for background' &
                                 // ' stratospheric sulfate bin_06'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAEROAREABGSULF07' )
          IF ( isDesc  ) Desc  = 'Wet aerosol area for background' &
                                 // ' stratospheric sulfate bin_07'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAEROAREABGSULF08' )
          IF ( isDesc  ) Desc  = 'Wet aerosol area for background' &
                                 // ' stratospheric sulfate bin_08'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAEROAREABGSULF09' )
          IF ( isDesc  ) Desc  = 'Wet aerosol area for background' &
                                 // ' stratospheric sulfate bin_09'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAEROAREABGSULF10' )
          IF ( isDesc  ) Desc  = 'Wet aerosol area for background' &
                                 // ' stratospheric sulfate bin_10'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAEROAREABGSULF11' )
          IF ( isDesc  ) Desc  = 'Wet aerosol area for background' &
                                 // ' stratospheric sulfate bin_11'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAEROAREABGSULF12' )
          IF ( isDesc  ) Desc  = 'Wet aerosol area for background' &
                                 // ' stratospheric sulfate bin_12'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAEROAREABGSULF13' )
          IF ( isDesc  ) Desc  = 'Wet aerosol area for background' &
                                 // ' stratospheric sulfate bin_13'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAEROAREABGSULF14' )
          IF ( isDesc  ) Desc  = 'Wet aerosol area for background' &
                                 // ' stratospheric sulfate bin_14'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAEROAREABGSULF15' )
          IF ( isDesc  ) Desc  = 'Wet aerosol area for background' &
                                 // ' stratospheric sulfate bin_15'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAEROAREABGSULF16' )
          IF ( isDesc  ) Desc  = 'Wet aerosol area for background' &
                                 // ' stratospheric sulfate bin_16'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAEROAREABGSULF17' )
          IF ( isDesc  ) Desc  = 'Wet aerosol area for background' &
                                 // ' stratospheric sulfate bin_17'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAEROAREABGSULF18' )
          IF ( isDesc  ) Desc  = 'Wet aerosol area for background' &
                                 // ' stratospheric sulfate bin_18'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAEROAREABGSULF19' )
          IF ( isDesc  ) Desc  = 'Wet aerosol area for background' &
                                 // ' stratospheric sulfate bin_19'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAEROAREABGSULF20' )
          IF ( isDesc  ) Desc  = 'Wet aerosol area for background' &
                                 // ' stratospheric sulfate bin_20'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAEROAREABGSULF21' )
          IF ( isDesc  ) Desc  = 'Wet aerosol area for background' &
                                 // ' stratospheric sulfate bin_21'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAEROAREABGSULF22' )
          IF ( isDesc  ) Desc  = 'Wet aerosol area for background' &
                                 // ' stratospheric sulfate bin_22'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAEROAREABGSULF23' )
          IF ( isDesc  ) Desc  = 'Wet aerosol area for background' &
                                 // ' stratospheric sulfate bin_23'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAEROAREABGSULF24' )
          IF ( isDesc  ) Desc  = 'Wet aerosol area for background' &
                                 // ' stratospheric sulfate bin_24'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAEROAREABGSULF25' )
          IF ( isDesc  ) Desc  = 'Wet aerosol area for background' &
                                 // ' stratospheric sulfate bin_25'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAEROAREABGSULF26' )
          IF ( isDesc  ) Desc  = 'Wet aerosol area for background' &
                                 // ' stratospheric sulfate bin_26'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAEROAREABGSULF27' )
          IF ( isDesc  ) Desc  = 'Wet aerosol area for background' &
                                 // ' stratospheric sulfate bin_27'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAEROAREABGSULF28' )
          IF ( isDesc  ) Desc  = 'Wet aerosol area for background' &
                                 // ' stratospheric sulfate bin_28'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAEROAREABGSULF29' )
          IF ( isDesc  ) Desc  = 'Wet aerosol area for background' &
                                 // ' stratospheric sulfate bin_29'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAEROAREABGSULF30' )
          IF ( isDesc  ) Desc  = 'Wet aerosol area for background' &
                                 // ' stratospheric sulfate bin_30'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAEROAREABGSULF31' )
          IF ( isDesc  ) Desc  = 'Wet aerosol area for background' &
                                 // ' stratospheric sulfate bin_31'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAEROAREABGSULF32' )
          IF ( isDesc  ) Desc  = 'Wet aerosol area for background' &
                                 // ' stratospheric sulfate bin_32'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAEROAREABGSULF33' )
          IF ( isDesc  ) Desc  = 'Wet aerosol area for background' &
                                 // ' stratospheric sulfate bin_33'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAEROAREABGSULF34' )
          IF ( isDesc  ) Desc  = 'Wet aerosol area for background' &
                                 // ' stratospheric sulfate bin_34'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAEROAREABGSULF35' )
          IF ( isDesc  ) Desc  = 'Wet aerosol area for background' &
                                 // ' stratospheric sulfate bin_35'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAEROAREABGSULF36' )
          IF ( isDesc  ) Desc  = 'Wet aerosol area for background' &
                                 // ' stratospheric sulfate bin_36'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAEROAREABGSULF37' )
          IF ( isDesc  ) Desc  = 'Wet aerosol area for background' &
                                 // ' stratospheric sulfate bin_37'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAEROAREABGSULF38' )
          IF ( isDesc  ) Desc  = 'Wet aerosol area for background' &
                                 // ' stratospheric sulfate bin_38'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAEROAREABGSULF39' )
          IF ( isDesc  ) Desc  = 'Wet aerosol area for background' &
                                 // ' stratospheric sulfate bin_39'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAEROAREABGSULF40' )
          IF ( isDesc  ) Desc  = 'Wet aerosol area for background' &
                                 // ' stratospheric sulfate bin_40'
          IF ( isUnits ) Units = 'cm2 cm-3'
          IF ( isRank  ) Rank  = 3
       ...
       !!! shw40
       CASE ( 'WETAERORADIBGSULF01' )
          IF ( isDesc  ) Desc  = 'Wet aerosol radius for background' &
                                // ' stratospheric sulfate bin_01'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAERORADIBGSULF02' )
          IF ( isDesc  ) Desc  = 'Wet aerosol radius for background' &
                                // ' stratospheric sulfate bin_02'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAERORADIBGSULF03' )
          IF ( isDesc  ) Desc  = 'Wet aerosol radius for background' &
                                // ' stratospheric sulfate bin_03'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAERORADIBGSULF04' )
          IF ( isDesc  ) Desc  = 'Wet aerosol radius for background' &
                                // ' stratospheric sulfate bin_04'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAERORADIBGSULF05' )
          IF ( isDesc  ) Desc  = 'Wet aerosol radius for background' &
                                // ' stratospheric sulfate bin_05'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAERORADIBGSULF06' )
          IF ( isDesc  ) Desc  = 'Wet aerosol radius for background' &
                                // ' stratospheric sulfate bin_06'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAERORADIBGSULF07' )
          IF ( isDesc  ) Desc  = 'Wet aerosol radius for background' &
                                // ' stratospheric sulfate bin_07'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAERORADIBGSULF08' )
          IF ( isDesc  ) Desc  = 'Wet aerosol radius for background' &
                                // ' stratospheric sulfate bin_08'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAERORADIBGSULF09' )
          IF ( isDesc  ) Desc  = 'Wet aerosol radius for background' &
                                // ' stratospheric sulfate bin_09'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAERORADIBGSULF10' )
          IF ( isDesc  ) Desc  = 'Wet aerosol radius for background' &
                                // ' stratospheric sulfate bin_10'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAERORADIBGSULF11' )
          IF ( isDesc  ) Desc  = 'Wet aerosol radius for background' &
                                // ' stratospheric sulfate bin_11'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAERORADIBGSULF12' )
          IF ( isDesc  ) Desc  = 'Wet aerosol radius for background' &
                                // ' stratospheric sulfate bin_12'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAERORADIBGSULF13' )
          IF ( isDesc  ) Desc  = 'Wet aerosol radius for background' &
                                // ' stratospheric sulfate bin_13'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAERORADIBGSULF14' )
          IF ( isDesc  ) Desc  = 'Wet aerosol radius for background' &
                                // ' stratospheric sulfate bin_14'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAERORADIBGSULF15' )
          IF ( isDesc  ) Desc  = 'Wet aerosol radius for background' &
                                // ' stratospheric sulfate bin_15'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAERORADIBGSULF16' )
          IF ( isDesc  ) Desc  = 'Wet aerosol radius for background' &
                                // ' stratospheric sulfate bin_16'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAERORADIBGSULF17' )
          IF ( isDesc  ) Desc  = 'Wet aerosol radius for background' &
                                // ' stratospheric sulfate bin_17'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAERORADIBGSULF18' )
          IF ( isDesc  ) Desc  = 'Wet aerosol radius for background' &
                                // ' stratospheric sulfate bin_18'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAERORADIBGSULF19' )
          IF ( isDesc  ) Desc  = 'Wet aerosol radius for background' &
                                // ' stratospheric sulfate bin_19'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAERORADIBGSULF20' )
          IF ( isDesc  ) Desc  = 'Wet aerosol radius for background' &
                                // ' stratospheric sulfate bin_20'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAERORADIBGSULF21' )
          IF ( isDesc  ) Desc  = 'Wet aerosol radius for background' &
                                // ' stratospheric sulfate bin_21'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAERORADIBGSULF22' )
          IF ( isDesc  ) Desc  = 'Wet aerosol radius for background' &
                                // ' stratospheric sulfate bin_22'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAERORADIBGSULF23' )
          IF ( isDesc  ) Desc  = 'Wet aerosol radius for background' &
                                // ' stratospheric sulfate bin_23'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAERORADIBGSULF24' )
          IF ( isDesc  ) Desc  = 'Wet aerosol radius for background' &
                                // ' stratospheric sulfate bin_24'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAERORADIBGSULF25' )
          IF ( isDesc  ) Desc  = 'Wet aerosol radius for background' &
                                // ' stratospheric sulfate bin_25'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAERORADIBGSULF26' )
          IF ( isDesc  ) Desc  = 'Wet aerosol radius for background' &
                                // ' stratospheric sulfate bin_26'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAERORADIBGSULF27' )
          IF ( isDesc  ) Desc  = 'Wet aerosol radius for background' &
                                // ' stratospheric sulfate bin_27'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAERORADIBGSULF28' )
          IF ( isDesc  ) Desc  = 'Wet aerosol radius for background' &
                                // ' stratospheric sulfate bin_28'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAERORADIBGSULF29' )
          IF ( isDesc  ) Desc  = 'Wet aerosol radius for background' &
                                // ' stratospheric sulfate bin_29'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAERORADIBGSULF30' )
          IF ( isDesc  ) Desc  = 'Wet aerosol radius for background' &
                                // ' stratospheric sulfate bin_30'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAERORADIBGSULF31' )
          IF ( isDesc  ) Desc  = 'Wet aerosol radius for background' &
                                // ' stratospheric sulfate bin_31'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAERORADIBGSULF32' )
          IF ( isDesc  ) Desc  = 'Wet aerosol radius for background' &
                                // ' stratospheric sulfate bin_32'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAERORADIBGSULF33' )
          IF ( isDesc  ) Desc  = 'Wet aerosol radius for background' &
                                // ' stratospheric sulfate bin_33'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAERORADIBGSULF34' )
          IF ( isDesc  ) Desc  = 'Wet aerosol radius for background' &
                                // ' stratospheric sulfate bin_34'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAERORADIBGSULF35' )
          IF ( isDesc  ) Desc  = 'Wet aerosol radius for background' &
                                // ' stratospheric sulfate bin_35'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAERORADIBGSULF36' )
          IF ( isDesc  ) Desc  = 'Wet aerosol radius for background' &
                                // ' stratospheric sulfate bin_36'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAERORADIBGSULF37' )
          IF ( isDesc  ) Desc  = 'Wet aerosol radius for background' &
                                // ' stratospheric sulfate bin_37'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAERORADIBGSULF38' )
          IF ( isDesc  ) Desc  = 'Wet aerosol radius for background' &
                                // ' stratospheric sulfate bin_38'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAERORADIBGSULF39' )
          IF ( isDesc  ) Desc  = 'Wet aerosol radius for background' &
                                // ' stratospheric sulfate bin_39'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3

       CASE ( 'WETAERORADIBGSULF40' )
          IF ( isDesc  ) Desc  = 'Wet aerosol radius for background' &
                                // ' stratospheric sulfate bin_40'
          IF ( isUnits ) Units = 'cm'
          IF ( isRank  ) Rank  = 3
       ...
       !!! shw40
       CASE ( 'AEROH2OBGSULF01' )
          IF ( isDesc  ) Desc  = 'Aerosol H2O content for background' &
                                // ' stratospheric sulfate bin_01'
          IF ( isUnits ) Units = 'cm3(H2O) cm-3(air)'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROH2OBGSULF02' )
          IF ( isDesc  ) Desc  = 'Aerosol H2O content for background' &
                                // ' stratospheric sulfate bin_02'
          IF ( isUnits ) Units = 'cm3(H2O) cm-3(air)'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROH2OBGSULF03' )
          IF ( isDesc  ) Desc  = 'Aerosol H2O content for background' &
                                // ' stratospheric sulfate bin_03'
          IF ( isUnits ) Units = 'cm3(H2O) cm-3(air)'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROH2OBGSULF04' )
          IF ( isDesc  ) Desc  = 'Aerosol H2O content for background' &
                                // ' stratospheric sulfate bin_04'
          IF ( isUnits ) Units = 'cm3(H2O) cm-3(air)'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROH2OBGSULF05' )
          IF ( isDesc  ) Desc  = 'Aerosol H2O content for background' &
                                // ' stratospheric sulfate bin_05'
          IF ( isUnits ) Units = 'cm3(H2O) cm-3(air)'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROH2OBGSULF06' )
          IF ( isDesc  ) Desc  = 'Aerosol H2O content for background' &
                                // ' stratospheric sulfate bin_06'
          IF ( isUnits ) Units = 'cm3(H2O) cm-3(air)'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROH2OBGSULF07' )
          IF ( isDesc  ) Desc  = 'Aerosol H2O content for background' &
                                // ' stratospheric sulfate bin_07'
          IF ( isUnits ) Units = 'cm3(H2O) cm-3(air)'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROH2OBGSULF08' )
          IF ( isDesc  ) Desc  = 'Aerosol H2O content for background' &
                                // ' stratospheric sulfate bin_08'
          IF ( isUnits ) Units = 'cm3(H2O) cm-3(air)'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROH2OBGSULF09' )
          IF ( isDesc  ) Desc  = 'Aerosol H2O content for background' &
                                // ' stratospheric sulfate bin_09'
          IF ( isUnits ) Units = 'cm3(H2O) cm-3(air)'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROH2OBGSULF10' )
          IF ( isDesc  ) Desc  = 'Aerosol H2O content for background' &
                                // ' stratospheric sulfate bin_10'
          IF ( isUnits ) Units = 'cm3(H2O) cm-3(air)'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROH2OBGSULF11' )
          IF ( isDesc  ) Desc  = 'Aerosol H2O content for background' &
                                // ' stratospheric sulfate bin_11'
          IF ( isUnits ) Units = 'cm3(H2O) cm-3(air)'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROH2OBGSULF12' )
          IF ( isDesc  ) Desc  = 'Aerosol H2O content for background' &
                                // ' stratospheric sulfate bin_12'
          IF ( isUnits ) Units = 'cm3(H2O) cm-3(air)'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROH2OBGSULF13' )
          IF ( isDesc  ) Desc  = 'Aerosol H2O content for background' &
                                // ' stratospheric sulfate bin_13'
          IF ( isUnits ) Units = 'cm3(H2O) cm-3(air)'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROH2OBGSULF14' )
          IF ( isDesc  ) Desc  = 'Aerosol H2O content for background' &
                                // ' stratospheric sulfate bin_14'
          IF ( isUnits ) Units = 'cm3(H2O) cm-3(air)'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROH2OBGSULF15' )
          IF ( isDesc  ) Desc  = 'Aerosol H2O content for background' &
                                // ' stratospheric sulfate bin_15'
          IF ( isUnits ) Units = 'cm3(H2O) cm-3(air)'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROH2OBGSULF16' )
          IF ( isDesc  ) Desc  = 'Aerosol H2O content for background' &
                                // ' stratospheric sulfate bin_16'
          IF ( isUnits ) Units = 'cm3(H2O) cm-3(air)'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROH2OBGSULF17' )
          IF ( isDesc  ) Desc  = 'Aerosol H2O content for background' &
                                // ' stratospheric sulfate bin_17'
          IF ( isUnits ) Units = 'cm3(H2O) cm-3(air)'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROH2OBGSULF18' )
          IF ( isDesc  ) Desc  = 'Aerosol H2O content for background' &
                                // ' stratospheric sulfate bin_18'
          IF ( isUnits ) Units = 'cm3(H2O) cm-3(air)'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROH2OBGSULF19' )
          IF ( isDesc  ) Desc  = 'Aerosol H2O content for background' &
                                // ' stratospheric sulfate bin_19'
          IF ( isUnits ) Units = 'cm3(H2O) cm-3(air)'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROH2OBGSULF20' )
          IF ( isDesc  ) Desc  = 'Aerosol H2O content for background' &
                                // ' stratospheric sulfate bin_20'
          IF ( isUnits ) Units = 'cm3(H2O) cm-3(air)'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROH2OBGSULF21' )
          IF ( isDesc  ) Desc  = 'Aerosol H2O content for background' &
                                // ' stratospheric sulfate bin_21'
          IF ( isUnits ) Units = 'cm3(H2O) cm-3(air)'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROH2OBGSULF22' )
          IF ( isDesc  ) Desc  = 'Aerosol H2O content for background' &
                                // ' stratospheric sulfate bin_22'
          IF ( isUnits ) Units = 'cm3(H2O) cm-3(air)'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROH2OBGSULF23' )
          IF ( isDesc  ) Desc  = 'Aerosol H2O content for background' &
                                // ' stratospheric sulfate bin_23'
          IF ( isUnits ) Units = 'cm3(H2O) cm-3(air)'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROH2OBGSULF24' )
          IF ( isDesc  ) Desc  = 'Aerosol H2O content for background' &
                                // ' stratospheric sulfate bin_24'
          IF ( isUnits ) Units = 'cm3(H2O) cm-3(air)'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROH2OBGSULF25' )
          IF ( isDesc  ) Desc  = 'Aerosol H2O content for background' &
                                // ' stratospheric sulfate bin_25'
          IF ( isUnits ) Units = 'cm3(H2O) cm-3(air)'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROH2OBGSULF26' )
          IF ( isDesc  ) Desc  = 'Aerosol H2O content for background' &
                                // ' stratospheric sulfate bin_26'
          IF ( isUnits ) Units = 'cm3(H2O) cm-3(air)'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROH2OBGSULF27' )
          IF ( isDesc  ) Desc  = 'Aerosol H2O content for background' &
                                // ' stratospheric sulfate bin_27'
          IF ( isUnits ) Units = 'cm3(H2O) cm-3(air)'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROH2OBGSULF28' )
          IF ( isDesc  ) Desc  = 'Aerosol H2O content for background' &
                                // ' stratospheric sulfate bin_28'
          IF ( isUnits ) Units = 'cm3(H2O) cm-3(air)'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROH2OBGSULF29' )
          IF ( isDesc  ) Desc  = 'Aerosol H2O content for background' &
                                // ' stratospheric sulfate bin_29'
          IF ( isUnits ) Units = 'cm3(H2O) cm-3(air)'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROH2OBGSULF30' )
          IF ( isDesc  ) Desc  = 'Aerosol H2O content for background' &
                                // ' stratospheric sulfate bin_30'
          IF ( isUnits ) Units = 'cm3(H2O) cm-3(air)'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROH2OBGSULF31' )
          IF ( isDesc  ) Desc  = 'Aerosol H2O content for background' &
                                // ' stratospheric sulfate bin_31'
          IF ( isUnits ) Units = 'cm3(H2O) cm-3(air)'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROH2OBGSULF32' )
          IF ( isDesc  ) Desc  = 'Aerosol H2O content for background' &
                                // ' stratospheric sulfate bin_32'
          IF ( isUnits ) Units = 'cm3(H2O) cm-3(air)'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROH2OBGSULF33' )
          IF ( isDesc  ) Desc  = 'Aerosol H2O content for background' &
                                // ' stratospheric sulfate bin_33'
          IF ( isUnits ) Units = 'cm3(H2O) cm-3(air)'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROH2OBGSULF34' )
          IF ( isDesc  ) Desc  = 'Aerosol H2O content for background' &
                                // ' stratospheric sulfate bin_34'
          IF ( isUnits ) Units = 'cm3(H2O) cm-3(air)'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROH2OBGSULF35' )
          IF ( isDesc  ) Desc  = 'Aerosol H2O content for background' &
                                // ' stratospheric sulfate bin_35'
          IF ( isUnits ) Units = 'cm3(H2O) cm-3(air)'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROH2OBGSULF36' )
          IF ( isDesc  ) Desc  = 'Aerosol H2O content for background' &
                                // ' stratospheric sulfate bin_36'
          IF ( isUnits ) Units = 'cm3(H2O) cm-3(air)'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROH2OBGSULF37' )
          IF ( isDesc  ) Desc  = 'Aerosol H2O content for background' &
                                // ' stratospheric sulfate bin_37'
          IF ( isUnits ) Units = 'cm3(H2O) cm-3(air)'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROH2OBGSULF38' )
          IF ( isDesc  ) Desc  = 'Aerosol H2O content for background' &
                                // ' stratospheric sulfate bin_38'
          IF ( isUnits ) Units = 'cm3(H2O) cm-3(air)'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROH2OBGSULF39' )
          IF ( isDesc  ) Desc  = 'Aerosol H2O content for background' &
                                // ' stratospheric sulfate bin_39'
          IF ( isUnits ) Units = 'cm3(H2O) cm-3(air)'
          IF ( isRank  ) Rank  = 3

       CASE ( 'AEROH2OBGSULF40' )
          IF ( isDesc  ) Desc  = 'Aerosol H2O content for background' &
                                // ' stratospheric sulfate bin_40'
          IF ( isUnits ) Units = 'cm3(H2O) cm-3(air)'
          IF ( isRank  ) Rank  = 3
...
!!! shw40_1
       ...
       CASE ( 'KHETISLAN2O5H2O_2' )
          IF ( isDesc  ) Desc  = 'BIN2 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5H2O_3' )
          IF ( isDesc  ) Desc  = 'BIN3 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5H2O_4' )
          IF ( isDesc  ) Desc  = 'BIN4 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5H2O_5' )
          IF ( isDesc  ) Desc  = 'BIN5 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5H2O_6' )
          IF ( isDesc  ) Desc  = 'BIN6 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5H2O_7' )
          IF ( isDesc  ) Desc  = 'BIN7 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5H2O_8' )
          IF ( isDesc  ) Desc  = 'BIN8 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5H2O_9' )
          IF ( isDesc  ) Desc  = 'BIN9 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5H2O_10' )
          IF ( isDesc  ) Desc  = 'BIN10 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5H2O_11' )
          IF ( isDesc  ) Desc  = 'BIN11 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5H2O_12' )
          IF ( isDesc  ) Desc  = 'BIN12 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5H2O_13' )
          IF ( isDesc  ) Desc  = 'BIN13 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5H2O_14' )
          IF ( isDesc  ) Desc  = 'BIN14 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5H2O_15' )
          IF ( isDesc  ) Desc  = 'BIN15 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5H2O_16' )
          IF ( isDesc  ) Desc  = 'BIN16 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5H2O_17' )
          IF ( isDesc  ) Desc  = 'BIN17 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5H2O_18' )
          IF ( isDesc  ) Desc  = 'BIN18 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5H2O_19' )
          IF ( isDesc  ) Desc  = 'BIN19 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5H2O_20' )
          IF ( isDesc  ) Desc  = 'BIN20 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5H2O_21' )
          IF ( isDesc  ) Desc  = 'BIN21 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5H2O_22' )
          IF ( isDesc  ) Desc  = 'BIN22 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5H2O_23' )
          IF ( isDesc  ) Desc  = 'BIN23 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5H2O_24' )
          IF ( isDesc  ) Desc  = 'BIN24 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5H2O_25' )
          IF ( isDesc  ) Desc  = 'BIN25 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5H2O_26' )
          IF ( isDesc  ) Desc  = 'BIN26 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5H2O_27' )
          IF ( isDesc  ) Desc  = 'BIN27 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5H2O_28' )
          IF ( isDesc  ) Desc  = 'BIN28 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5H2O_29' )
          IF ( isDesc  ) Desc  = 'BIN29 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5H2O_30' )
          IF ( isDesc  ) Desc  = 'BIN30 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5H2O_31' )
          IF ( isDesc  ) Desc  = 'BIN31 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5H2O_32' )
          IF ( isDesc  ) Desc  = 'BIN32 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5H2O_33' )
          IF ( isDesc  ) Desc  = 'BIN33 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5H2O_34' )
          IF ( isDesc  ) Desc  = 'BIN34 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5H2O_35' )
          IF ( isDesc  ) Desc  = 'BIN35 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5H2O_36' )
          IF ( isDesc  ) Desc  = 'BIN36 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5H2O_37' )
          IF ( isDesc  ) Desc  = 'BIN37 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5H2O_38' )
          IF ( isDesc  ) Desc  = 'BIN38 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5H2O_39' )
          IF ( isDesc  ) Desc  = 'BIN39 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5H2O_40' )
          IF ( isDesc  ) Desc  = 'BIN40 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3
       ...
       CASE ( 'KHETISLAN2O5HCL_1' )
          IF ( isDesc  ) Desc  = 'BIN1 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5HCL_2' )
          IF ( isDesc  ) Desc  = 'BIN2 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5HCL_3' )
          IF ( isDesc  ) Desc  = 'BIN3 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5HCL_4' )
          IF ( isDesc  ) Desc  = 'BIN4 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5HCL_5' )
          IF ( isDesc  ) Desc  = 'BIN5 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5HCL_6' )
          IF ( isDesc  ) Desc  = 'BIN6 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5HCL_7' )
          IF ( isDesc  ) Desc  = 'BIN7 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5HCL_8' )
          IF ( isDesc  ) Desc  = 'BIN8 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5HCL_9' )
          IF ( isDesc  ) Desc  = 'BIN9 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5HCL_10' )
          IF ( isDesc  ) Desc  = 'BIN10 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5HCL_11' )
          IF ( isDesc  ) Desc  = 'BIN11 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5HCL_12' )
          IF ( isDesc  ) Desc  = 'BIN12 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5HCL_13' )
          IF ( isDesc  ) Desc  = 'BIN13 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5HCL_14' )
          IF ( isDesc  ) Desc  = 'BIN14 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5HCL_15' )
          IF ( isDesc  ) Desc  = 'BIN15 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5HCL_16' )
          IF ( isDesc  ) Desc  = 'BIN16 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5HCL_17' )
          IF ( isDesc  ) Desc  = 'BIN17 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5HCL_18' )
          IF ( isDesc  ) Desc  = 'BIN18 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5HCL_19' )
          IF ( isDesc  ) Desc  = 'BIN19 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5HCL_20' )
          IF ( isDesc  ) Desc  = 'BIN20 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5HCL_21' )
          IF ( isDesc  ) Desc  = 'BIN21 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5HCL_22' )
          IF ( isDesc  ) Desc  = 'BIN22 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5HCL_23' )
          IF ( isDesc  ) Desc  = 'BIN23 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5HCL_24' )
          IF ( isDesc  ) Desc  = 'BIN24 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5HCL_25' )
          IF ( isDesc  ) Desc  = 'BIN25 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5HCL_26' )
          IF ( isDesc  ) Desc  = 'BIN26 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5HCL_27' )
          IF ( isDesc  ) Desc  = 'BIN27 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5HCL_28' )
          IF ( isDesc  ) Desc  = 'BIN28 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5HCL_29' )
          IF ( isDesc  ) Desc  = 'BIN29 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5HCL_30' )
          IF ( isDesc  ) Desc  = 'BIN30 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5HCL_31' )
          IF ( isDesc  ) Desc  = 'BIN31 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5HCL_32' )
          IF ( isDesc  ) Desc  = 'BIN32 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5HCL_33' )
          IF ( isDesc  ) Desc  = 'BIN33 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5HCL_34' )
          IF ( isDesc  ) Desc  = 'BIN34 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5HCL_35' )
          IF ( isDesc  ) Desc  = 'BIN35 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5HCL_36' )
          IF ( isDesc  ) Desc  = 'BIN36 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5HCL_37' )
          IF ( isDesc  ) Desc  = 'BIN37 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5HCL_38' )
          IF ( isDesc  ) Desc  = 'BIN38 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5HCL_39' )
          IF ( isDesc  ) Desc  = 'BIN39 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAN2O5HCL_40' )
          IF ( isDesc  ) Desc  = 'BIN40 Sticking coefficient for N2O5 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3
       ...
       CASE ( 'KHETISLACLNO3H2O_1' )
          IF ( isDesc  ) Desc  = 'BIN1 Sticking coefficient for ClNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3H2O_2' )
          IF ( isDesc  ) Desc  = 'BIN2 Sticking coefficient for ClNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3H2O_3' )
          IF ( isDesc  ) Desc  = 'BIN3 Sticking coefficient for ClNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3H2O_4' )
          IF ( isDesc  ) Desc  = 'BIN4 Sticking coefficient for ClNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3H2O_5' )
          IF ( isDesc  ) Desc  = 'BIN5 Sticking coefficient for ClNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3H2O_6' )
          IF ( isDesc  ) Desc  = 'BIN6 Sticking coefficient for ClNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3H2O_7' )
          IF ( isDesc  ) Desc  = 'BIN7 Sticking coefficient for ClNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3H2O_8' )
          IF ( isDesc  ) Desc  = 'BIN8 Sticking coefficient for ClNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3H2O_9' )
          IF ( isDesc  ) Desc  = 'BIN9 Sticking coefficient for ClNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3H2O_10' )
          IF ( isDesc  ) Desc  = 'BIN10 Sticking coefficient for ClNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3H2O_11' )
          IF ( isDesc  ) Desc  = 'BIN11 Sticking coefficient for ClNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3H2O_12' )
          IF ( isDesc  ) Desc  = 'BIN12 Sticking coefficient for ClNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3H2O_13' )
          IF ( isDesc  ) Desc  = 'BIN13 Sticking coefficient for ClNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3H2O_14' )
          IF ( isDesc  ) Desc  = 'BIN14 Sticking coefficient for ClNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3H2O_15' )
          IF ( isDesc  ) Desc  = 'BIN15 Sticking coefficient for ClNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3H2O_16' )
          IF ( isDesc  ) Desc  = 'BIN16 Sticking coefficient for ClNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3H2O_17' )
          IF ( isDesc  ) Desc  = 'BIN17 Sticking coefficient for ClNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3H2O_18' )
          IF ( isDesc  ) Desc  = 'BIN18 Sticking coefficient for ClNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3H2O_19' )
          IF ( isDesc  ) Desc  = 'BIN19 Sticking coefficient for ClNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3H2O_20' )
          IF ( isDesc  ) Desc  = 'BIN20 Sticking coefficient for ClNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3H2O_21' )
          IF ( isDesc  ) Desc  = 'BIN21 Sticking coefficient for ClNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3H2O_22' )
          IF ( isDesc  ) Desc  = 'BIN22 Sticking coefficient for ClNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3H2O_23' )
          IF ( isDesc  ) Desc  = 'BIN23 Sticking coefficient for ClNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3H2O_24' )
          IF ( isDesc  ) Desc  = 'BIN24 Sticking coefficient for ClNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3H2O_25' )
          IF ( isDesc  ) Desc  = 'BIN25 Sticking coefficient for ClNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3H2O_26' )
          IF ( isDesc  ) Desc  = 'BIN26 Sticking coefficient for ClNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3H2O_27' )
          IF ( isDesc  ) Desc  = 'BIN27 Sticking coefficient for ClNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3H2O_28' )
          IF ( isDesc  ) Desc  = 'BIN28 Sticking coefficient for ClNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3H2O_29' )
          IF ( isDesc  ) Desc  = 'BIN29 Sticking coefficient for ClNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3H2O_30' )
          IF ( isDesc  ) Desc  = 'BIN30 Sticking coefficient for ClNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3H2O_31' )
          IF ( isDesc  ) Desc  = 'BIN31 Sticking coefficient for ClNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3H2O_32' )
          IF ( isDesc  ) Desc  = 'BIN32 Sticking coefficient for ClNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3H2O_33' )
          IF ( isDesc  ) Desc  = 'BIN33 Sticking coefficient for ClNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3H2O_34' )
          IF ( isDesc  ) Desc  = 'BIN34 Sticking coefficient for ClNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3H2O_35' )
          IF ( isDesc  ) Desc  = 'BIN35 Sticking coefficient for ClNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3H2O_36' )
          IF ( isDesc  ) Desc  = 'BIN36 Sticking coefficient for ClNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3H2O_37' )
          IF ( isDesc  ) Desc  = 'BIN37 Sticking coefficient for ClNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3H2O_38' )
          IF ( isDesc  ) Desc  = 'BIN38 Sticking coefficient for ClNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3H2O_39' )
          IF ( isDesc  ) Desc  = 'BIN39 Sticking coefficient for ClNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3H2O_40' )
          IF ( isDesc  ) Desc  = 'BIN40 Sticking coefficient for ClNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3
       ...
       CASE ( 'KHETISLACLNO3HCL_1' )
          IF ( isDesc  ) Desc  = 'BIN1 Sticking coefficient for ClNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HCL_2' )
          IF ( isDesc  ) Desc  = 'BIN2 Sticking coefficient for ClNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HCL_3' )
          IF ( isDesc  ) Desc  = 'BIN3 Sticking coefficient for ClNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HCL_4' )
          IF ( isDesc  ) Desc  = 'BIN4 Sticking coefficient for ClNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HCL_5' )
          IF ( isDesc  ) Desc  = 'BIN5 Sticking coefficient for ClNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HCL_6' )
          IF ( isDesc  ) Desc  = 'BIN6 Sticking coefficient for ClNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HCL_7' )
          IF ( isDesc  ) Desc  = 'BIN7 Sticking coefficient for ClNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HCL_8' )
          IF ( isDesc  ) Desc  = 'BIN8 Sticking coefficient for ClNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HCL_9' )
          IF ( isDesc  ) Desc  = 'BIN9 Sticking coefficient for ClNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HCL_10' )
          IF ( isDesc  ) Desc  = 'BIN10 Sticking coefficient for ClNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HCL_11' )
          IF ( isDesc  ) Desc  = 'BIN11 Sticking coefficient for ClNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HCL_12' )
          IF ( isDesc  ) Desc  = 'BIN12 Sticking coefficient for ClNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HCL_13' )
          IF ( isDesc  ) Desc  = 'BIN13 Sticking coefficient for ClNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HCL_14' )
          IF ( isDesc  ) Desc  = 'BIN14 Sticking coefficient for ClNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HCL_15' )
          IF ( isDesc  ) Desc  = 'BIN15 Sticking coefficient for ClNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HCL_16' )
          IF ( isDesc  ) Desc  = 'BIN16 Sticking coefficient for ClNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HCL_17' )
          IF ( isDesc  ) Desc  = 'BIN17 Sticking coefficient for ClNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HCL_18' )
          IF ( isDesc  ) Desc  = 'BIN18 Sticking coefficient for ClNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HCL_19' )
          IF ( isDesc  ) Desc  = 'BIN19 Sticking coefficient for ClNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HCL_20' )
          IF ( isDesc  ) Desc  = 'BIN20 Sticking coefficient for ClNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HCL_21' )
          IF ( isDesc  ) Desc  = 'BIN21 Sticking coefficient for ClNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HCL_22' )
          IF ( isDesc  ) Desc  = 'BIN22 Sticking coefficient for ClNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HCL_23' )
          IF ( isDesc  ) Desc  = 'BIN23 Sticking coefficient for ClNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HCL_24' )
          IF ( isDesc  ) Desc  = 'BIN24 Sticking coefficient for ClNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HCL_25' )
          IF ( isDesc  ) Desc  = 'BIN25 Sticking coefficient for ClNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HCL_26' )
          IF ( isDesc  ) Desc  = 'BIN26 Sticking coefficient for ClNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HCL_27' )
          IF ( isDesc  ) Desc  = 'BIN27 Sticking coefficient for ClNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HCL_28' )
          IF ( isDesc  ) Desc  = 'BIN28 Sticking coefficient for ClNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HCL_29' )
          IF ( isDesc  ) Desc  = 'BIN29 Sticking coefficient for ClNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HCL_30' )
          IF ( isDesc  ) Desc  = 'BIN30 Sticking coefficient for ClNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HCL_31' )
          IF ( isDesc  ) Desc  = 'BIN31 Sticking coefficient for ClNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HCL_32' )
          IF ( isDesc  ) Desc  = 'BIN32 Sticking coefficient for ClNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HCL_33' )
          IF ( isDesc  ) Desc  = 'BIN33 Sticking coefficient for ClNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HCL_34' )
          IF ( isDesc  ) Desc  = 'BIN34 Sticking coefficient for ClNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HCL_35' )
          IF ( isDesc  ) Desc  = 'BIN35 Sticking coefficient for ClNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HCL_36' )
          IF ( isDesc  ) Desc  = 'BIN36 Sticking coefficient for ClNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HCL_37' )
          IF ( isDesc  ) Desc  = 'BIN37 Sticking coefficient for ClNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HCL_38' )
          IF ( isDesc  ) Desc  = 'BIN38 Sticking coefficient for ClNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HCL_39' )
          IF ( isDesc  ) Desc  = 'BIN39 Sticking coefficient for ClNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HCL_40' )
          IF ( isDesc  ) Desc  = 'BIN40 Sticking coefficient for ClNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3
       ...
       CASE ( 'KHETISLACLNO3HBR_1' )
          IF ( isDesc  ) Desc  = 'BIN1 Sticking coefficient for ClNO3 + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HBR_2' )
          IF ( isDesc  ) Desc  = 'BIN2 Sticking coefficient for ClNO3 + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HBR_3' )
          IF ( isDesc  ) Desc  = 'BIN3 Sticking coefficient for ClNO3 + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HBR_4' )
          IF ( isDesc  ) Desc  = 'BIN4 Sticking coefficient for ClNO3 + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HBR_5' )
          IF ( isDesc  ) Desc  = 'BIN5 Sticking coefficient for ClNO3 + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HBR_6' )
          IF ( isDesc  ) Desc  = 'BIN6 Sticking coefficient for ClNO3 + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HBR_7' )
          IF ( isDesc  ) Desc  = 'BIN7 Sticking coefficient for ClNO3 + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HBR_8' )
          IF ( isDesc  ) Desc  = 'BIN8 Sticking coefficient for ClNO3 + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HBR_9' )
          IF ( isDesc  ) Desc  = 'BIN9 Sticking coefficient for ClNO3 + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HBR_10' )
          IF ( isDesc  ) Desc  = 'BIN10 Sticking coefficient for ClNO3 + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HBR_11' )
          IF ( isDesc  ) Desc  = 'BIN11 Sticking coefficient for ClNO3 + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HBR_12' )
          IF ( isDesc  ) Desc  = 'BIN12 Sticking coefficient for ClNO3 + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HBR_13' )
          IF ( isDesc  ) Desc  = 'BIN13 Sticking coefficient for ClNO3 + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HBR_14' )
          IF ( isDesc  ) Desc  = 'BIN14 Sticking coefficient for ClNO3 + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HBR_15' )
          IF ( isDesc  ) Desc  = 'BIN15 Sticking coefficient for ClNO3 + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HBR_16' )
          IF ( isDesc  ) Desc  = 'BIN16 Sticking coefficient for ClNO3 + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HBR_17' )
          IF ( isDesc  ) Desc  = 'BIN17 Sticking coefficient for ClNO3 + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HBR_18' )
          IF ( isDesc  ) Desc  = 'BIN18 Sticking coefficient for ClNO3 + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HBR_19' )
          IF ( isDesc  ) Desc  = 'BIN19 Sticking coefficient for ClNO3 + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HBR_20' )
          IF ( isDesc  ) Desc  = 'BIN20 Sticking coefficient for ClNO3 + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HBR_21' )
          IF ( isDesc  ) Desc  = 'BIN21 Sticking coefficient for ClNO3 + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HBR_22' )
          IF ( isDesc  ) Desc  = 'BIN22 Sticking coefficient for ClNO3 + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HBR_23' )
          IF ( isDesc  ) Desc  = 'BIN23 Sticking coefficient for ClNO3 + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HBR_24' )
          IF ( isDesc  ) Desc  = 'BIN24 Sticking coefficient for ClNO3 + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HBR_25' )
          IF ( isDesc  ) Desc  = 'BIN25 Sticking coefficient for ClNO3 + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HBR_26' )
          IF ( isDesc  ) Desc  = 'BIN26 Sticking coefficient for ClNO3 + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HBR_27' )
          IF ( isDesc  ) Desc  = 'BIN27 Sticking coefficient for ClNO3 + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HBR_28' )
          IF ( isDesc  ) Desc  = 'BIN28 Sticking coefficient for ClNO3 + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HBR_29' )
          IF ( isDesc  ) Desc  = 'BIN29 Sticking coefficient for ClNO3 + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HBR_30' )
          IF ( isDesc  ) Desc  = 'BIN30 Sticking coefficient for ClNO3 + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HBR_31' )
          IF ( isDesc  ) Desc  = 'BIN31 Sticking coefficient for ClNO3 + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HBR_32' )
          IF ( isDesc  ) Desc  = 'BIN32 Sticking coefficient for ClNO3 + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HBR_33' )
          IF ( isDesc  ) Desc  = 'BIN33 Sticking coefficient for ClNO3 + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HBR_34' )
          IF ( isDesc  ) Desc  = 'BIN34 Sticking coefficient for ClNO3 + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HBR_35' )
          IF ( isDesc  ) Desc  = 'BIN35 Sticking coefficient for ClNO3 + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HBR_36' )
          IF ( isDesc  ) Desc  = 'BIN36 Sticking coefficient for ClNO3 + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HBR_37' )
          IF ( isDesc  ) Desc  = 'BIN37 Sticking coefficient for ClNO3 + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HBR_38' )
          IF ( isDesc  ) Desc  = 'BIN38 Sticking coefficient for ClNO3 + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HBR_39' )
          IF ( isDesc  ) Desc  = 'BIN39 Sticking coefficient for ClNO3 + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLACLNO3HBR_40' )
          IF ( isDesc  ) Desc  = 'BIN40 Sticking coefficient for ClNO3 + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3
       ...
       CASE ( 'KHETISLABRNO3H2O_1' )
          IF ( isDesc  ) Desc  = 'BIN1 Sticking coefficient for BrNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3H2O_2' )
          IF ( isDesc  ) Desc  = 'BIN2 Sticking coefficient for BrNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3H2O_3' )
          IF ( isDesc  ) Desc  = 'BIN3 Sticking coefficient for BrNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3H2O_4' )
          IF ( isDesc  ) Desc  = 'BIN4 Sticking coefficient for BrNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3H2O_5' )
          IF ( isDesc  ) Desc  = 'BIN5 Sticking coefficient for BrNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3H2O_6' )
          IF ( isDesc  ) Desc  = 'BIN6 Sticking coefficient for BrNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3H2O_7' )
          IF ( isDesc  ) Desc  = 'BIN7 Sticking coefficient for BrNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3H2O_8' )
          IF ( isDesc  ) Desc  = 'BIN8 Sticking coefficient for BrNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3H2O_9' )
          IF ( isDesc  ) Desc  = 'BIN9 Sticking coefficient for BrNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3H2O_10' )
          IF ( isDesc  ) Desc  = 'BIN10 Sticking coefficient for BrNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3H2O_11' )
          IF ( isDesc  ) Desc  = 'BIN11 Sticking coefficient for BrNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3H2O_12' )
          IF ( isDesc  ) Desc  = 'BIN12 Sticking coefficient for BrNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3H2O_13' )
          IF ( isDesc  ) Desc  = 'BIN13 Sticking coefficient for BrNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3H2O_14' )
          IF ( isDesc  ) Desc  = 'BIN14 Sticking coefficient for BrNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3H2O_15' )
          IF ( isDesc  ) Desc  = 'BIN15 Sticking coefficient for BrNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3H2O_16' )
          IF ( isDesc  ) Desc  = 'BIN16 Sticking coefficient for BrNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3H2O_17' )
          IF ( isDesc  ) Desc  = 'BIN17 Sticking coefficient for BrNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3H2O_18' )
          IF ( isDesc  ) Desc  = 'BIN18 Sticking coefficient for BrNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3H2O_19' )
          IF ( isDesc  ) Desc  = 'BIN19 Sticking coefficient for BrNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3H2O_20' )
          IF ( isDesc  ) Desc  = 'BIN20 Sticking coefficient for BrNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3H2O_21' )
          IF ( isDesc  ) Desc  = 'BIN21 Sticking coefficient for BrNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3H2O_22' )
          IF ( isDesc  ) Desc  = 'BIN22 Sticking coefficient for BrNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3H2O_23' )
          IF ( isDesc  ) Desc  = 'BIN23 Sticking coefficient for BrNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3H2O_24' )
          IF ( isDesc  ) Desc  = 'BIN24 Sticking coefficient for BrNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3H2O_25' )
          IF ( isDesc  ) Desc  = 'BIN25 Sticking coefficient for BrNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3H2O_26' )
          IF ( isDesc  ) Desc  = 'BIN26 Sticking coefficient for BrNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3H2O_27' )
          IF ( isDesc  ) Desc  = 'BIN27 Sticking coefficient for BrNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3H2O_28' )
          IF ( isDesc  ) Desc  = 'BIN28 Sticking coefficient for BrNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3H2O_29' )
          IF ( isDesc  ) Desc  = 'BIN29 Sticking coefficient for BrNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3H2O_30' )
          IF ( isDesc  ) Desc  = 'BIN30 Sticking coefficient for BrNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3H2O_31' )
          IF ( isDesc  ) Desc  = 'BIN31 Sticking coefficient for BrNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3H2O_32' )
          IF ( isDesc  ) Desc  = 'BIN32 Sticking coefficient for BrNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3H2O_33' )
          IF ( isDesc  ) Desc  = 'BIN33 Sticking coefficient for BrNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3H2O_34' )
          IF ( isDesc  ) Desc  = 'BIN34 Sticking coefficient for BrNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3H2O_35' )
          IF ( isDesc  ) Desc  = 'BIN35 Sticking coefficient for BrNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3H2O_36' )
          IF ( isDesc  ) Desc  = 'BIN36 Sticking coefficient for BrNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3H2O_37' )
          IF ( isDesc  ) Desc  = 'BIN37 Sticking coefficient for BrNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3H2O_38' )
          IF ( isDesc  ) Desc  = 'BIN38 Sticking coefficient for BrNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3H2O_39' )
          IF ( isDesc  ) Desc  = 'BIN39 Sticking coefficient for BrNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3H2O_40' )
          IF ( isDesc  ) Desc  = 'BIN40 Sticking coefficient for BrNO3 + H2O reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3
       ...
       CASE ( 'KHETISLABRNO3HCL_1' )
          IF ( isDesc  ) Desc  = 'BIN1 Sticking coefficient for BrNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3HCL_2' )
          IF ( isDesc  ) Desc  = 'BIN2 Sticking coefficient for BrNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3HCL_3' )
          IF ( isDesc  ) Desc  = 'BIN3 Sticking coefficient for BrNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3HCL_4' )
          IF ( isDesc  ) Desc  = 'BIN4 Sticking coefficient for BrNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3HCL_5' )
          IF ( isDesc  ) Desc  = 'BIN5 Sticking coefficient for BrNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3HCL_6' )
          IF ( isDesc  ) Desc  = 'BIN6 Sticking coefficient for BrNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3HCL_7' )
          IF ( isDesc  ) Desc  = 'BIN7 Sticking coefficient for BrNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3HCL_8' )
          IF ( isDesc  ) Desc  = 'BIN8 Sticking coefficient for BrNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3HCL_9' )
          IF ( isDesc  ) Desc  = 'BIN9 Sticking coefficient for BrNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3HCL_10' )
          IF ( isDesc  ) Desc  = 'BIN10 Sticking coefficient for BrNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3HCL_11' )
          IF ( isDesc  ) Desc  = 'BIN11 Sticking coefficient for BrNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3HCL_12' )
          IF ( isDesc  ) Desc  = 'BIN12 Sticking coefficient for BrNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3HCL_13' )
          IF ( isDesc  ) Desc  = 'BIN13 Sticking coefficient for BrNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3HCL_14' )
          IF ( isDesc  ) Desc  = 'BIN14 Sticking coefficient for BrNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3HCL_15' )
          IF ( isDesc  ) Desc  = 'BIN15 Sticking coefficient for BrNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3HCL_16' )
          IF ( isDesc  ) Desc  = 'BIN16 Sticking coefficient for BrNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3HCL_17' )
          IF ( isDesc  ) Desc  = 'BIN17 Sticking coefficient for BrNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3HCL_18' )
          IF ( isDesc  ) Desc  = 'BIN18 Sticking coefficient for BrNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3HCL_19' )
          IF ( isDesc  ) Desc  = 'BIN19 Sticking coefficient for BrNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3HCL_20' )
          IF ( isDesc  ) Desc  = 'BIN20 Sticking coefficient for BrNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3HCL_21' )
          IF ( isDesc  ) Desc  = 'BIN21 Sticking coefficient for BrNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3HCL_22' )
          IF ( isDesc  ) Desc  = 'BIN22 Sticking coefficient for BrNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3HCL_23' )
          IF ( isDesc  ) Desc  = 'BIN23 Sticking coefficient for BrNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3HCL_24' )
          IF ( isDesc  ) Desc  = 'BIN24 Sticking coefficient for BrNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3HCL_25' )
          IF ( isDesc  ) Desc  = 'BIN25 Sticking coefficient for BrNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3HCL_26' )
          IF ( isDesc  ) Desc  = 'BIN26 Sticking coefficient for BrNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3HCL_27' )
          IF ( isDesc  ) Desc  = 'BIN27 Sticking coefficient for BrNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3HCL_28' )
          IF ( isDesc  ) Desc  = 'BIN28 Sticking coefficient for BrNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3HCL_29' )
          IF ( isDesc  ) Desc  = 'BIN29 Sticking coefficient for BrNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3HCL_30' )
          IF ( isDesc  ) Desc  = 'BIN30 Sticking coefficient for BrNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3HCL_31' )
          IF ( isDesc  ) Desc  = 'BIN31 Sticking coefficient for BrNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3HCL_32' )
          IF ( isDesc  ) Desc  = 'BIN32 Sticking coefficient for BrNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3HCL_33' )
          IF ( isDesc  ) Desc  = 'BIN33 Sticking coefficient for BrNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3HCL_34' )
          IF ( isDesc  ) Desc  = 'BIN34 Sticking coefficient for BrNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3HCL_35' )
          IF ( isDesc  ) Desc  = 'BIN35 Sticking coefficient for BrNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3HCL_36' )
          IF ( isDesc  ) Desc  = 'BIN36 Sticking coefficient for BrNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3HCL_37' )
          IF ( isDesc  ) Desc  = 'BIN37 Sticking coefficient for BrNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3HCL_38' )
          IF ( isDesc  ) Desc  = 'BIN38 Sticking coefficient for BrNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3HCL_39' )
          IF ( isDesc  ) Desc  = 'BIN39 Sticking coefficient for BrNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLABRNO3HCL_40' )
          IF ( isDesc  ) Desc  = 'BIN40 Sticking coefficient for BrNO3 + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3
       ...
       CASE ( 'KHETISLAHOCLHCL_1' )
          IF ( isDesc  ) Desc  = 'BIN1 Sticking coefficient for HOCl + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHCL_2' )
          IF ( isDesc  ) Desc  = 'BIN2 Sticking coefficient for HOCl + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHCL_3' )
          IF ( isDesc  ) Desc  = 'BIN3 Sticking coefficient for HOCl + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHCL_4' )
          IF ( isDesc  ) Desc  = 'BIN4 Sticking coefficient for HOCl + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHCL_5' )
          IF ( isDesc  ) Desc  = 'BIN5 Sticking coefficient for HOCl + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHCL_6' )
          IF ( isDesc  ) Desc  = 'BIN6 Sticking coefficient for HOCl + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHCL_7' )
          IF ( isDesc  ) Desc  = 'BIN7 Sticking coefficient for HOCl + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHCL_8' )
          IF ( isDesc  ) Desc  = 'BIN8 Sticking coefficient for HOCl + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHCL_9' )
          IF ( isDesc  ) Desc  = 'BIN9 Sticking coefficient for HOCl + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHCL_10' )
          IF ( isDesc  ) Desc  = 'BIN10 Sticking coefficient for HOCl + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHCL_11' )
          IF ( isDesc  ) Desc  = 'BIN11 Sticking coefficient for HOCl + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHCL_12' )
          IF ( isDesc  ) Desc  = 'BIN12 Sticking coefficient for HOCl + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHCL_13' )
          IF ( isDesc  ) Desc  = 'BIN13 Sticking coefficient for HOCl + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHCL_14' )
          IF ( isDesc  ) Desc  = 'BIN14 Sticking coefficient for HOCl + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHCL_15' )
          IF ( isDesc  ) Desc  = 'BIN15 Sticking coefficient for HOCl + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHCL_16' )
          IF ( isDesc  ) Desc  = 'BIN16 Sticking coefficient for HOCl + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHCL_17' )
          IF ( isDesc  ) Desc  = 'BIN17 Sticking coefficient for HOCl + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHCL_18' )
          IF ( isDesc  ) Desc  = 'BIN18 Sticking coefficient for HOCl + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHCL_19' )
          IF ( isDesc  ) Desc  = 'BIN19 Sticking coefficient for HOCl + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHCL_20' )
          IF ( isDesc  ) Desc  = 'BIN20 Sticking coefficient for HOCl + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHCL_21' )
          IF ( isDesc  ) Desc  = 'BIN21 Sticking coefficient for HOCl + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHCL_22' )
          IF ( isDesc  ) Desc  = 'BIN22 Sticking coefficient for HOCl + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHCL_23' )
          IF ( isDesc  ) Desc  = 'BIN23 Sticking coefficient for HOCl + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHCL_24' )
          IF ( isDesc  ) Desc  = 'BIN24 Sticking coefficient for HOCl + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHCL_25' )
          IF ( isDesc  ) Desc  = 'BIN25 Sticking coefficient for HOCl + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHCL_26' )
          IF ( isDesc  ) Desc  = 'BIN26 Sticking coefficient for HOCl + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHCL_27' )
          IF ( isDesc  ) Desc  = 'BIN27 Sticking coefficient for HOCl + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHCL_28' )
          IF ( isDesc  ) Desc  = 'BIN28 Sticking coefficient for HOCl + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHCL_29' )
          IF ( isDesc  ) Desc  = 'BIN29 Sticking coefficient for HOCl + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHCL_30' )
          IF ( isDesc  ) Desc  = 'BIN30 Sticking coefficient for HOCl + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHCL_31' )
          IF ( isDesc  ) Desc  = 'BIN31 Sticking coefficient for HOCl + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHCL_32' )
          IF ( isDesc  ) Desc  = 'BIN32 Sticking coefficient for HOCl + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHCL_33' )
          IF ( isDesc  ) Desc  = 'BIN33 Sticking coefficient for HOCl + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHCL_34' )
          IF ( isDesc  ) Desc  = 'BIN34 Sticking coefficient for HOCl + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHCL_35' )
          IF ( isDesc  ) Desc  = 'BIN35 Sticking coefficient for HOCl + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHCL_36' )
          IF ( isDesc  ) Desc  = 'BIN36 Sticking coefficient for HOCl + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHCL_37' )
          IF ( isDesc  ) Desc  = 'BIN37 Sticking coefficient for HOCl + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHCL_38' )
          IF ( isDesc  ) Desc  = 'BIN38 Sticking coefficient for HOCl + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHCL_39' )
          IF ( isDesc  ) Desc  = 'BIN39 Sticking coefficient for HOCl + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHCL_40' )
          IF ( isDesc  ) Desc  = 'BIN40 Sticking coefficient for HOCl + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3
       ...
       CASE ( 'KHETISLAHOCLHBR_1' )
          IF ( isDesc  ) Desc  = 'BIN1 Sticking coefficient for HClr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHBR_2' )
          IF ( isDesc  ) Desc  = 'BIN2 Sticking coefficient for HClr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHBR_3' )
          IF ( isDesc  ) Desc  = 'BIN3 Sticking coefficient for HClr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHBR_4' )
          IF ( isDesc  ) Desc  = 'BIN4 Sticking coefficient for HClr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHBR_5' )
          IF ( isDesc  ) Desc  = 'BIN5 Sticking coefficient for HClr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHBR_6' )
          IF ( isDesc  ) Desc  = 'BIN6 Sticking coefficient for HClr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHBR_7' )
          IF ( isDesc  ) Desc  = 'BIN7 Sticking coefficient for HClr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHBR_8' )
          IF ( isDesc  ) Desc  = 'BIN8 Sticking coefficient for HClr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHBR_9' )
          IF ( isDesc  ) Desc  = 'BIN9 Sticking coefficient for HClr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHBR_10' )
          IF ( isDesc  ) Desc  = 'BIN10 Sticking coefficient for HClr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHBR_11' )
          IF ( isDesc  ) Desc  = 'BIN11 Sticking coefficient for HClr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHBR_12' )
          IF ( isDesc  ) Desc  = 'BIN12 Sticking coefficient for HClr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHBR_13' )
          IF ( isDesc  ) Desc  = 'BIN13 Sticking coefficient for HClr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHBR_14' )
          IF ( isDesc  ) Desc  = 'BIN14 Sticking coefficient for HClr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHBR_15' )
          IF ( isDesc  ) Desc  = 'BIN15 Sticking coefficient for HClr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHBR_16' )
          IF ( isDesc  ) Desc  = 'BIN16 Sticking coefficient for HClr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHBR_17' )
          IF ( isDesc  ) Desc  = 'BIN17 Sticking coefficient for HClr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHBR_18' )
          IF ( isDesc  ) Desc  = 'BIN18 Sticking coefficient for HClr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHBR_19' )
          IF ( isDesc  ) Desc  = 'BIN19 Sticking coefficient for HClr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHBR_20' )
          IF ( isDesc  ) Desc  = 'BIN20 Sticking coefficient for HClr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHBR_21' )
          IF ( isDesc  ) Desc  = 'BIN21 Sticking coefficient for HClr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHBR_22' )
          IF ( isDesc  ) Desc  = 'BIN22 Sticking coefficient for HClr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHBR_23' )
          IF ( isDesc  ) Desc  = 'BIN23 Sticking coefficient for HClr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHBR_24' )
          IF ( isDesc  ) Desc  = 'BIN24 Sticking coefficient for HClr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHBR_25' )
          IF ( isDesc  ) Desc  = 'BIN25 Sticking coefficient for HClr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHBR_26' )
          IF ( isDesc  ) Desc  = 'BIN26 Sticking coefficient for HClr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHBR_27' )
          IF ( isDesc  ) Desc  = 'BIN27 Sticking coefficient for HClr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHBR_28' )
          IF ( isDesc  ) Desc  = 'BIN28 Sticking coefficient for HClr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHBR_29' )
          IF ( isDesc  ) Desc  = 'BIN29 Sticking coefficient for HClr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHBR_30' )
          IF ( isDesc  ) Desc  = 'BIN30 Sticking coefficient for HClr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHBR_31' )
          IF ( isDesc  ) Desc  = 'BIN31 Sticking coefficient for HClr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHBR_32' )
          IF ( isDesc  ) Desc  = 'BIN32 Sticking coefficient for HClr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHBR_33' )
          IF ( isDesc  ) Desc  = 'BIN33 Sticking coefficient for HClr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHBR_34' )
          IF ( isDesc  ) Desc  = 'BIN34 Sticking coefficient for HClr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHBR_35' )
          IF ( isDesc  ) Desc  = 'BIN35 Sticking coefficient for HClr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHBR_36' )
          IF ( isDesc  ) Desc  = 'BIN36 Sticking coefficient for HClr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHBR_37' )
          IF ( isDesc  ) Desc  = 'BIN37 Sticking coefficient for HClr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHBR_38' )
          IF ( isDesc  ) Desc  = 'BIN38 Sticking coefficient for HClr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHBR_39' )
          IF ( isDesc  ) Desc  = 'BIN39 Sticking coefficient for HClr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOCLHBR_40' )
          IF ( isDesc  ) Desc  = 'BIN40 Sticking coefficient for HClr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3
       ...
       CASE ( 'KHETISLAHOBRHCL_1' )
          IF ( isDesc  ) Desc  = 'BIN1 Sticking coefficient for HOBr + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHCL_2' )
          IF ( isDesc  ) Desc  = 'BIN2 Sticking coefficient for HOBr + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHCL_3' )
          IF ( isDesc  ) Desc  = 'BIN3 Sticking coefficient for HOBr + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHCL_4' )
          IF ( isDesc  ) Desc  = 'BIN4 Sticking coefficient for HOBr + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHCL_5' )
          IF ( isDesc  ) Desc  = 'BIN5 Sticking coefficient for HOBr + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHCL_6' )
          IF ( isDesc  ) Desc  = 'BIN6 Sticking coefficient for HOBr + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHCL_7' )
          IF ( isDesc  ) Desc  = 'BIN7 Sticking coefficient for HOBr + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHCL_8' )
          IF ( isDesc  ) Desc  = 'BIN8 Sticking coefficient for HOBr + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHCL_9' )
          IF ( isDesc  ) Desc  = 'BIN9 Sticking coefficient for HOBr + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHCL_10' )
          IF ( isDesc  ) Desc  = 'BIN10 Sticking coefficient for HOBr + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHCL_11' )
          IF ( isDesc  ) Desc  = 'BIN11 Sticking coefficient for HOBr + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHCL_12' )
          IF ( isDesc  ) Desc  = 'BIN12 Sticking coefficient for HOBr + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHCL_13' )
          IF ( isDesc  ) Desc  = 'BIN13 Sticking coefficient for HOBr + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHCL_14' )
          IF ( isDesc  ) Desc  = 'BIN14 Sticking coefficient for HOBr + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHCL_15' )
          IF ( isDesc  ) Desc  = 'BIN15 Sticking coefficient for HOBr + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHCL_16' )
          IF ( isDesc  ) Desc  = 'BIN16 Sticking coefficient for HOBr + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHCL_17' )
          IF ( isDesc  ) Desc  = 'BIN17 Sticking coefficient for HOBr + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHCL_18' )
          IF ( isDesc  ) Desc  = 'BIN18 Sticking coefficient for HOBr + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHCL_19' )
          IF ( isDesc  ) Desc  = 'BIN19 Sticking coefficient for HOBr + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHCL_20' )
          IF ( isDesc  ) Desc  = 'BIN20 Sticking coefficient for HOBr + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHCL_21' )
          IF ( isDesc  ) Desc  = 'BIN21 Sticking coefficient for HOBr + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHCL_22' )
          IF ( isDesc  ) Desc  = 'BIN22 Sticking coefficient for HOBr + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHCL_23' )
          IF ( isDesc  ) Desc  = 'BIN23 Sticking coefficient for HOBr + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHCL_24' )
          IF ( isDesc  ) Desc  = 'BIN24 Sticking coefficient for HOBr + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHCL_25' )
          IF ( isDesc  ) Desc  = 'BIN25 Sticking coefficient for HOBr + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHCL_26' )
          IF ( isDesc  ) Desc  = 'BIN26 Sticking coefficient for HOBr + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHCL_27' )
          IF ( isDesc  ) Desc  = 'BIN27 Sticking coefficient for HOBr + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHCL_28' )
          IF ( isDesc  ) Desc  = 'BIN28 Sticking coefficient for HOBr + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHCL_29' )
          IF ( isDesc  ) Desc  = 'BIN29 Sticking coefficient for HOBr + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHCL_30' )
          IF ( isDesc  ) Desc  = 'BIN30 Sticking coefficient for HOBr + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHCL_31' )
          IF ( isDesc  ) Desc  = 'BIN31 Sticking coefficient for HOBr + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHCL_32' )
          IF ( isDesc  ) Desc  = 'BIN32 Sticking coefficient for HOBr + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHCL_33' )
          IF ( isDesc  ) Desc  = 'BIN33 Sticking coefficient for HOBr + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHCL_34' )
          IF ( isDesc  ) Desc  = 'BIN34 Sticking coefficient for HOBr + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHCL_35' )
          IF ( isDesc  ) Desc  = 'BIN35 Sticking coefficient for HOBr + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHCL_36' )
          IF ( isDesc  ) Desc  = 'BIN36 Sticking coefficient for HOBr + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHCL_37' )
          IF ( isDesc  ) Desc  = 'BIN37 Sticking coefficient for HOBr + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHCL_38' )
          IF ( isDesc  ) Desc  = 'BIN38 Sticking coefficient for HOBr + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHCL_39' )
          IF ( isDesc  ) Desc  = 'BIN39 Sticking coefficient for HOBr + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHCL_40' )
          IF ( isDesc  ) Desc  = 'BIN40 Sticking coefficient for HOBr + HCl reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3
       ...
       CASE ( 'KHETISLAHOBRHBR_1' )
          IF ( isDesc  ) Desc  = 'BIN1 Sticking coefficient for HOBr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHBR_2' )
          IF ( isDesc  ) Desc  = 'BIN2 Sticking coefficient for HOBr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHBR_3' )
          IF ( isDesc  ) Desc  = 'BIN3 Sticking coefficient for HOBr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHBR_4' )
          IF ( isDesc  ) Desc  = 'BIN4 Sticking coefficient for HOBr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHBR_5' )
          IF ( isDesc  ) Desc  = 'BIN5 Sticking coefficient for HOBr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHBR_6' )
          IF ( isDesc  ) Desc  = 'BIN6 Sticking coefficient for HOBr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHBR_7' )
          IF ( isDesc  ) Desc  = 'BIN7 Sticking coefficient for HOBr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHBR_8' )
          IF ( isDesc  ) Desc  = 'BIN8 Sticking coefficient for HOBr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHBR_9' )
          IF ( isDesc  ) Desc  = 'BIN9 Sticking coefficient for HOBr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHBR_10' )
          IF ( isDesc  ) Desc  = 'BIN10 Sticking coefficient for HOBr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHBR_11' )
          IF ( isDesc  ) Desc  = 'BIN11 Sticking coefficient for HOBr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHBR_12' )
          IF ( isDesc  ) Desc  = 'BIN12 Sticking coefficient for HOBr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHBR_13' )
          IF ( isDesc  ) Desc  = 'BIN13 Sticking coefficient for HOBr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHBR_14' )
          IF ( isDesc  ) Desc  = 'BIN14 Sticking coefficient for HOBr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHBR_15' )
          IF ( isDesc  ) Desc  = 'BIN15 Sticking coefficient for HOBr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHBR_16' )
          IF ( isDesc  ) Desc  = 'BIN16 Sticking coefficient for HOBr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHBR_17' )
          IF ( isDesc  ) Desc  = 'BIN17 Sticking coefficient for HOBr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHBR_18' )
          IF ( isDesc  ) Desc  = 'BIN18 Sticking coefficient for HOBr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHBR_19' )
          IF ( isDesc  ) Desc  = 'BIN19 Sticking coefficient for HOBr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHBR_20' )
          IF ( isDesc  ) Desc  = 'BIN20 Sticking coefficient for HOBr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHBR_21' )
          IF ( isDesc  ) Desc  = 'BIN21 Sticking coefficient for HOBr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHBR_22' )
          IF ( isDesc  ) Desc  = 'BIN22 Sticking coefficient for HOBr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHBR_23' )
          IF ( isDesc  ) Desc  = 'BIN23 Sticking coefficient for HOBr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHBR_24' )
          IF ( isDesc  ) Desc  = 'BIN24 Sticking coefficient for HOBr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHBR_25' )
          IF ( isDesc  ) Desc  = 'BIN25 Sticking coefficient for HOBr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHBR_26' )
          IF ( isDesc  ) Desc  = 'BIN26 Sticking coefficient for HOBr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHBR_27' )
          IF ( isDesc  ) Desc  = 'BIN27 Sticking coefficient for HOBr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHBR_28' )
          IF ( isDesc  ) Desc  = 'BIN28 Sticking coefficient for HOBr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHBR_29' )
          IF ( isDesc  ) Desc  = 'BIN29 Sticking coefficient for HOBr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHBR_30' )
          IF ( isDesc  ) Desc  = 'BIN30 Sticking coefficient for HOBr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHBR_31' )
          IF ( isDesc  ) Desc  = 'BIN31 Sticking coefficient for HOBr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHBR_32' )
          IF ( isDesc  ) Desc  = 'BIN32 Sticking coefficient for HOBr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHBR_33' )
          IF ( isDesc  ) Desc  = 'BIN33 Sticking coefficient for HOBr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHBR_34' )
          IF ( isDesc  ) Desc  = 'BIN34 Sticking coefficient for HOBr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHBR_35' )
          IF ( isDesc  ) Desc  = 'BIN35 Sticking coefficient for HOBr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHBR_36' )
          IF ( isDesc  ) Desc  = 'BIN36 Sticking coefficient for HOBr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHBR_37' )
          IF ( isDesc  ) Desc  = 'BIN37 Sticking coefficient for HOBr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHBR_38' )
          IF ( isDesc  ) Desc  = 'BIN38 Sticking coefficient for HOBr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHBR_39' )
          IF ( isDesc  ) Desc  = 'BIN39 Sticking coefficient for HOBr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3

       CASE ( 'KHETISLAHOBRHBR_40' )
          IF ( isDesc  ) Desc  = 'BIN40 Sticking coefficient for HOBr + HBr reaction'
          IF ( isUnits ) Units = '1'
          IF ( isRank  ) Rank  = 3
