...
!  real(fp), parameter :: Init_radius = 10.0e+0_fp ! 100.0e+0_fp ! 2.0e+0_fp ! 10.0e+0_fp     ! [m], the width of each ring
  ...
  integer, parameter  :: n_rings_max = 300 ! 500  ! 100          ! Degine the number of rings in one box
...
!    box_radiusB(:,1)  = (/2.0e+0_fp,  2.0e+0_fp,  2.0e+0_fp/)     ! m
    ...
    box_radiusA(:,1)  = (/5.0e+0_fp,  5.0e+0_fp,  5.0e+0_fp/)     ! the value of the innest ring for every box
    box_radiusB(:,1)  = (/5.0e+0_fp,  5.0e+0_fp,  5.0e+0_fp/)     ! m
...
!         1.1420088289968512e-09, 9.364949424197002e-10, 7.673508446499213e-10 /)
        ...
        box_concnt(1,1:50) = (/ 49.96875976359082, 49.5024916874584, &
                48.03947195761616, 45.69655926356141, 42.607189448310564, 38.94003915357025, &
                34.883816303551555, 30.631319709220804, 26.364621202152428, 22.242903311147057, &
                18.393972058572118, 14.909863971494369, 11.846387934106088, 9.225976199649462, &
                7.04292104605225, 5.269961228093217, 3.865237022164987, 2.778810630574153, &
                1.9581947549493532, 1.3525923433175209, 0.9157819444367089, 0.6077589164957468, &
                0.3953527025796721, 0.25208801298454897, 0.15755557992222208, &
                0.09652270681138546, 0.05796145869522957, 0.03411640263781883, &
                0.019683452032753915, 0.011131492845944448, 0.006170490204333978, &
                0.003352741215140556, 0.0017856424820817606, 0.000932187116575841, &
                0.0004770081436539615, 0.00023925586960645045, 0.00011762876000048855, &
                5.6686356937398304e-05, 2.6776739013965544e-05, 1.2397980090225139e-05, &
                5.626758735962956e-06, 2.5031090103835243e-06, 1.091478897562739e-06, &
                4.6651437872525027e-07, 1.9544692171324321e-07, 8.026140275928058e-08, &
                3.230715886553054e-08, 1.2746909401959845e-08, 4.929752787995758e-09, &
                1.868785663972128e-09 /)
