...
MODULE Plume_Mod
  ...
  real(fp), parameter :: Init_radius = 100.0e+0_fp ! 2.0e+0_fp ! 10.0e+0_fp     ! [m], the width of each ring
  real(fp), parameter :: D_radius    = 100.0e+0_fp ! 2.0e+0_fp ! 10.0e+0_fp     ! [m], the width of each ring
  integer, parameter  :: n_rings_max = 500  ! 100          ! Degine the number of rings in one box
